...
> extends PostGraphileCoreOptions {
  ...
  // By default, database objects within generated queries consist of the
  // PostgreSQL schema name and table name separated by a dot.  Set 'true' to
  // omit the schema name, such that relevant table is determined based on the
  // current search_path.  Useful in multi-tenant applications (not recommended).
