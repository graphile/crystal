select
  __random_user_array_set_idx__::text as "0",
  __random_user_array_set__."id" as "1",
  __random_user_array_set__."username" as "2",
  __random_user_array_set__."gravatar_url" as "3"
