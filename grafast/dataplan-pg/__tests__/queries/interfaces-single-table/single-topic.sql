...
lateral (
  select
    __single_table_items__."title" as "0",
    to_char(__single_table_items__."archived_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM'::text) as "1",
    __single_table_items__."is_explicitly_archived"::text as "2",
    to_char(__single_table_items__."updated_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM'::text) as "3",
    ...
    __single_table_items__."id"::text as "8",
