...
export type WithPgClientStepCallback<TPgClient extends PgClient, TData, TResult> = (
  client: TPgClient,
  data: TData,
) => Promise<TResult>;
...
export function withPgClientTransaction<TPgClient extends PgClient, TData, TResult>(
  executor: PgExecutor,
  $data:
    | ExecutableStep<TData>
    | (TData extends null | undefined ? null | undefined : never),
