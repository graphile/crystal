...
The building block we came up with, our holy grail, was the "plan resolver": a
...
{{RESOLVER VS PLAN RESOLVER}}

{/* We knew that the ergonomics of these functions would be critical, so we
spent a lot of time making sure that they felt and flowed right; and then
literal years making them work. */} The various plan resolvers referenced by the
...
proven stable in production, but the documentation needs to catch up (and some
TypeScript types and comments still need to be brought in line). An RC gives us
...
revisit plan resolvers? Help us improve our explanations here; share your
feedback in our [Discord](https://discord.gg/graphile) or with GitHub issues and
pull requests!
