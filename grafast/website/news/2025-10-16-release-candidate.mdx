...
this release candidate. They also complete the mental model we advocate in
[“Thinking in plans”](/grafast/flow): you describe the desired dataflow once,
Gra*fast* optimizes it, and execution reuses that plan safely across requests.
With unary dependencies tidied, branching controlled, and polymorphism tamed,
it is now straightforward to reason about how values move through the graph.
