...
If you maintain a GraphQL server in JavaScript/TypeScript and you want to add
<Grafast /> support, don't hesitate to get in touch! Reach out on [our
Discord](https://discord.gg/graphile) or find another way of contacting us.
...
Grafserv automatically implements all optimizations that we could think of for
...
const getEnveloped = envelop({
  plugins: [
    ...
    // Enable this in development only for easier debugging:
