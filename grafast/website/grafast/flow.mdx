...
Gra*fast* is a dataflow engine: every request is satisfied by flowing values
through a graph of steps that were planned ahead of time. This page expands on
that mental model so you can reason about Gra*fast*'s optimisation choices and
structure your own plan resolvers accordingly.
