...
You do not need to use TypeScript to use <Grafast />, but without it you will
...
See [grafast/getting-started](https://github.com/grafast/getting-started) for
this project fully fleshed
out.
