...
- [list][]: takes a list of steps and turns it into a single step that yields a
  list of the underlying steps' values
- [object][]: takes an object, the keys of which are steps, and turns it into a
  single step that yields an object where the values are the corresponding
...
- [multistep][]: accepts a step, tuple, object, or thunk returning those and
  returns a single step matching the same shape
