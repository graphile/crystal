...
For fuller definitions of layer plans and buckets, see the
[Layer plans](./operation-plan.mdx#layer-plans) section and the
[Bucket](./glossary.md#bucket) and [Layer plan](./glossary.md#layer-plan)
glossary entries.
