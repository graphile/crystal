...
permissive MIT license, including Gra<em>fast</em>, PostGraphile, Graphile Worker,
...
featured in the README files of Graphile’s main open source projects. Choose the tier
which matches your funding goal, higher tiers come with more benefits.
