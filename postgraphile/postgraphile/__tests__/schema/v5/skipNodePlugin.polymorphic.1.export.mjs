...
import { ConnectionStep, ConstantStep, EdgeStep, ObjectStep, __ValueStep, assertStep, bakedInput, bakedInputRuntime, connection, constant, context, createObjectAndApplyChildren, first, get as get2, lambda, makeGrafastSchema, object, operationPlan, stepAMayDependOnStepB, trap } from "grafast";
...
const LogEntryCondition_rowIdApply = ($condition, val) => applyAttributeCondition("id", TYPES.int, $condition, val);
...
const LogEntryOrderBy_ROW_ID_ASCApply = queryBuilder => {
...
const LogEntryOrderBy_ROW_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "id",
    direction: "DESC"
  });
...
const LogEntryOrderBy_PERSON_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "person_id",
    direction: "ASC"
  });
};
const LogEntryOrderBy_PERSON_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "person_id",
    direction: "DESC"
  });
};
const LogEntryOrderBy_ORGANIZATION_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "organization_id",
    direction: "ASC"
  });
};
const LogEntryOrderBy_ORGANIZATION_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "organization_id",
    direction: "DESC"
  });
...
const AwsApplicationFirstPartyVulnerability_awsApplicationIdPlan = $record => {
  return $record.get("aws_application_id");
};
const AwsApplicationFirstPartyVulnerability_firstPartyVulnerabilityIdPlan = $record => {
  return $record.get("first_party_vulnerability_id");
};
const AwsApplicationFirstPartyVulnerability_firstPartyVulnerabilityByFirstPartyVulnerabilityIdPlan = $record => paths_0_resource_first_party_vulnerabilitiesPgResource.get({
  id: $record.get("first_party_vulnerability_id")
});
const AwsApplicationFirstPartyVulnerability_awsApplicationByAwsApplicationIdPlan = $record => otherSource_aws_applicationsPgResource.get({
...
const AwsApplicationFirstPartyVulnerabilityCondition_awsApplicationIdApply = ($condition, val) => applyAttributeCondition("aws_application_id", TYPES.int, $condition, val);
const AwsApplicationFirstPartyVulnerabilityCondition_firstPartyVulnerabilityIdApply = ($condition, val) => applyAttributeCondition("first_party_vulnerability_id", TYPES.int, $condition, val);
const AwsApplicationFirstPartyVulnerabilityOrderBy_AWS_APPLICATION_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
...
const AwsApplicationFirstPartyVulnerabilityOrderBy_AWS_APPLICATION_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "aws_application_id",
    direction: "DESC"
  });
...
const AwsApplicationFirstPartyVulnerabilityOrderBy_FIRST_PARTY_VULNERABILITY_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "first_party_vulnerability_id",
    direction: "ASC"
  });
};
const AwsApplicationFirstPartyVulnerabilityOrderBy_FIRST_PARTY_VULNERABILITY_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "first_party_vulnerability_id",
    direction: "DESC"
  });
};
const GcpApplicationFirstPartyVulnerability_gcpApplicationIdPlan = $record => {
  return $record.get("gcp_application_id");
};
const GcpApplicationFirstPartyVulnerability_gcpApplicationByGcpApplicationIdPlan = $record => otherSource_gcp_applicationsPgResource.get({
...
const GcpApplicationFirstPartyVulnerabilityCondition_gcpApplicationIdApply = ($condition, val) => applyAttributeCondition("gcp_application_id", TYPES.int, $condition, val);
const GcpApplicationFirstPartyVulnerabilityOrderBy_GCP_APPLICATION_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
...
const GcpApplicationFirstPartyVulnerabilityOrderBy_GCP_APPLICATION_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "gcp_application_id",
    direction: "DESC"
  });
...
const GcpApplicationThirdPartyVulnerability_thirdPartyVulnerabilityIdPlan = $record => {
  return $record.get("third_party_vulnerability_id");
};
const GcpApplicationThirdPartyVulnerability_thirdPartyVulnerabilityByThirdPartyVulnerabilityIdPlan = $record => paths_1_resource_third_party_vulnerabilitiesPgResource.get({
...
const AwsApplicationThirdPartyVulnerabilityCondition_thirdPartyVulnerabilityIdApply = ($condition, val) => applyAttributeCondition("third_party_vulnerability_id", TYPES.int, $condition, val);
const AwsApplicationThirdPartyVulnerabilityOrderBy_THIRD_PARTY_VULNERABILITY_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "third_party_vulnerability_id",
    direction: "ASC"
  });
};
const AwsApplicationThirdPartyVulnerabilityOrderBy_THIRD_PARTY_VULNERABILITY_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "third_party_vulnerability_id",
    direction: "DESC"
  });
...
const ApplicationCondition_lastDeployedApply = ($condition, val) => applyAttributeCondition("last_deployed", TYPES.timestamptz, $condition, val);
const ApplicationOrderBy_ROW_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "id",
    direction: "ASC"
  });
};
const ApplicationOrderBy_ROW_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "id",
    direction: "DESC"
  });
};
const ApplicationOrderBy_NAME_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "name",
    direction: "ASC"
  });
};
const ApplicationOrderBy_NAME_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "name",
    direction: "DESC"
  });
};
const ApplicationOrderBy_LAST_DEPLOYED_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "last_deployed",
    direction: "ASC"
  });
};
const ApplicationOrderBy_LAST_DEPLOYED_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "last_deployed",
    direction: "DESC"
  });
...
const VulnerabilityOrderBy_CVSS_SCORE_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "cvss_score",
    direction: "ASC"
  });
};
const VulnerabilityOrderBy_CVSS_SCORE_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "cvss_score",
    direction: "DESC"
  });
...
const SingleTableItemOrderBy_PARENT_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "parent_id",
    direction: "ASC"
  });
};
const SingleTableItemOrderBy_PARENT_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "parent_id",
    direction: "DESC"
  });
};
const SingleTableItemOrderBy_ROOT_TOPIC_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "root_topic_id",
    direction: "ASC"
  });
};
const SingleTableItemOrderBy_ROOT_TOPIC_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "root_topic_id",
    direction: "DESC"
  });
};
const SingleTableItemOrderBy_AUTHOR_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "author_id",
    direction: "ASC"
  });
};
const SingleTableItemOrderBy_AUTHOR_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "author_id",
    direction: "DESC"
  });
};
const SingleTableItemOrderBy_POSITION_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "position",
    direction: "ASC"
  });
};
const SingleTableItemOrderBy_POSITION_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "position",
    direction: "DESC"
  });
};
const SingleTableItemOrderBy_CREATED_AT_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "created_at",
    direction: "ASC"
  });
};
const SingleTableItemOrderBy_CREATED_AT_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "created_at",
    direction: "DESC"
  });
};
const SingleTableItemOrderBy_UPDATED_AT_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "updated_at",
    direction: "ASC"
  });
};
const SingleTableItemOrderBy_UPDATED_AT_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "updated_at",
    direction: "DESC"
  });
};
const SingleTableItemOrderBy_IS_EXPLICITLY_ARCHIVED_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "is_explicitly_archived",
    direction: "ASC"
  });
};
const SingleTableItemOrderBy_IS_EXPLICITLY_ARCHIVED_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "is_explicitly_archived",
    direction: "DESC"
  });
};
const SingleTableItemOrderBy_ARCHIVED_AT_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "archived_at",
    direction: "ASC"
  });
};
const SingleTableItemOrderBy_ARCHIVED_AT_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "archived_at",
    direction: "DESC"
  });
...
const SingleTableItemRelationOrderBy_PARENT_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "parent_id",
    direction: "ASC"
  });
...
const SingleTableItemRelationOrderBy_PARENT_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "parent_id",
    direction: "DESC"
  });
...
const SingleTableItemRelationOrderBy_CHILD_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "child_id",
    direction: "ASC"
  });
};
const SingleTableItemRelationOrderBy_CHILD_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "child_id",
    direction: "DESC"
  });
...
const PriorityCondition_titleApply = ($condition, val) => applyAttributeCondition("title", TYPES.text, $condition, val);
const PriorityOrderBy_TITLE_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "title",
    direction: "ASC"
  });
};
const PriorityOrderBy_TITLE_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "title",
    direction: "DESC"
  });
...
const RelationalChecklistItemOrderBy_DESCRIPTION_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "description",
    direction: "ASC"
  });
};
const RelationalChecklistItemOrderBy_DESCRIPTION_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "description",
    direction: "DESC"
  });
};
const RelationalChecklistItemOrderBy_NOTE_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "note",
    direction: "ASC"
  });
};
const RelationalChecklistItemOrderBy_NOTE_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "note",
    direction: "DESC"
  });
...
const CreateAwsApplicationFirstPartyVulnerabilityPayload_awsApplicationFirstPartyVulnerabilityEdgePlan = ($mutation, fieldArgs) => pgMutationPayloadEdge(otherSource_aws_application_first_party_vulnerabilitiesPgResource, aws_application_first_party_vulnerabilitiesUniques[0].attributes, $mutation, fieldArgs);
...
function AwsApplicationInput_rowIdApply(obj, val, info) {
...
type Query {
  ...
  allCollections(
    ...
    orderBy: [CollectionOrderBy!] = [PRIMARY_KEY_ASC]
...
export const objects = {
  ...
  Mutation: {
    ...
    plans: {
      createAwsApplication: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_aws_applicationsPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createAwsApplicationFirstPartyVulnerability: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_aws_application_first_party_vulnerabilitiesPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createAwsApplicationThirdPartyVulnerability: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_aws_application_third_party_vulnerabilitiesPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createFirstPartyVulnerability: {
        plan(_, args) {
          const $insert = pgInsertSingle(paths_0_resource_first_party_vulnerabilitiesPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createGcpApplication: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_gcp_applicationsPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createGcpApplicationFirstPartyVulnerability: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_gcp_application_first_party_vulnerabilitiesPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createGcpApplicationThirdPartyVulnerability: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_gcp_application_third_party_vulnerabilitiesPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createLogEntry: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_log_entriesPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createOrganization: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_organizationsPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createPriority: {
        plan(_, args) {
          const $insert = pgInsertSingle(otherSource_prioritiesPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createRelationalItemRelation: {
        plan(_, args) {
          const $insert = pgInsertSingle(resource_relational_item_relationsPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createRelationalItemRelationCompositePk: {
        plan(_, args) {
          const $insert = pgInsertSingle(resource_relational_item_relation_composite_pksPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      createThirdPartyVulnerability: {
        plan(_, args) {
          const $insert = pgInsertSingle(paths_1_resource_third_party_vulnerabilitiesPgResource);
          args.apply($insert);
          return object({
            result: $insert
          });
      ...
      deleteRelationalItemRelationByParentIdAndChildId: {
        plan(_$root, args) {
          const $delete = pgDeleteSingle(resource_relational_item_relationsPgResource, {
      ...
      deleteRelationalItemRelationCompositePkByParentIdAndChildId: {
        plan(_$root, args) {
          const $delete = pgDeleteSingle(resource_relational_item_relation_composite_pksPgResource, {
            parent_id: args.getRaw(['input', "parentId"]),
            child_id: args.getRaw(['input', "childId"])
          });
          args.apply($delete);
      ...
      updateRelationalItemRelationByParentIdAndChildId: {
        plan(_$root, args) {
          const $update = pgUpdateSingle(resource_relational_item_relationsPgResource, {
            parent_id: args.getRaw(['input', "parentId"]),
            child_id: args.getRaw(['input', "childId"])
          });
          args.apply($update);
      ...
      updateRelationalItemRelationCompositePkByParentIdAndChildId: {
        plan(_$root, args) {
          const $update = pgUpdateSingle(resource_relational_item_relation_composite_pksPgResource, {
            parent_id: args.getRaw(['input', "parentId"]),
            child_id: args.getRaw(['input', "childId"])
          });
          args.apply($update);
  ...
  AwsApplicationFirstPartyVulnerability: {
    assertStep: assertPgClassSingleStep,
    plans: {
      awsApplicationByAwsApplicationId: AwsApplicationFirstPartyVulnerability_awsApplicationByAwsApplicationIdPlan,
      awsApplicationId: AwsApplicationFirstPartyVulnerability_awsApplicationIdPlan,
      firstPartyVulnerabilityByFirstPartyVulnerabilityId: AwsApplicationFirstPartyVulnerability_firstPartyVulnerabilityByFirstPartyVulnerabilityIdPlan,
      firstPartyVulnerabilityId: AwsApplicationFirstPartyVulnerability_firstPartyVulnerabilityIdPlan
    },
    planType($specifier) {
      const spec = Object.create(null);
      for (const pkCol of aws_application_first_party_vulnerabilitiesUniques[0].attributes) {
        spec[pkCol] = get2($specifier, pkCol);
      }
      return otherSource_aws_application_first_party_vulnerabilitiesPgResource.get(spec);
    }
  },
  AwsApplicationFirstPartyVulnerabilityConnection: {
    assertStep: ConnectionStep,
  ...
  AwsApplicationThirdPartyVulnerability: {
    ...
    plans: {
      awsApplicationByAwsApplicationId: AwsApplicationFirstPartyVulnerability_awsApplicationByAwsApplicationIdPlan,
      awsApplicationId: AwsApplicationFirstPartyVulnerability_awsApplicationIdPlan,
      thirdPartyVulnerabilityByThirdPartyVulnerabilityId: GcpApplicationThirdPartyVulnerability_thirdPartyVulnerabilityByThirdPartyVulnerabilityIdPlan,
      thirdPartyVulnerabilityId: GcpApplicationThirdPartyVulnerability_thirdPartyVulnerabilityIdPlan
    },
    planType($specifier) {
      const spec = Object.create(null);
      for (const pkCol of aws_application_third_party_vulnerabilitiesUniques[0].attributes) {
        spec[pkCol] = get2($specifier, pkCol);
      }
      return otherSource_aws_application_third_party_vulnerabilitiesPgResource.get(spec);
    }
  },
  AwsApplicationThirdPartyVulnerabilityConnection: {
    assertStep: ConnectionStep,
  ...
  CreateAwsApplicationFirstPartyVulnerabilityPayload: {
    ...
    plans: {
      awsApplicationFirstPartyVulnerability: planCreatePayloadResult,
      awsApplicationFirstPartyVulnerabilityEdge: CreateAwsApplicationFirstPartyVulnerabilityPayload_awsApplicationFirstPartyVulnerabilityEdgePlan,
  ...
  CreateAwsApplicationThirdPartyVulnerabilityPayload: {
    assertStep: assertStep,
    plans: {
      awsApplicationThirdPartyVulnerability: planCreatePayloadResult,
      awsApplicationThirdPartyVulnerabilityEdge: CreateAwsApplicationThirdPartyVulnerabilityPayload_awsApplicationThirdPartyVulnerabilityEdgePlan,
      clientMutationId: getClientMutationIdForCreatePlan,
      query: queryPlan
    }
  },
  ...
  CreateGcpApplicationFirstPartyVulnerabilityPayload: {
    ...
    plans: {
      clientMutationId: getClientMutationIdForCreatePlan,
      gcpApplicationFirstPartyVulnerability: planCreatePayloadResult,
      gcpApplicationFirstPartyVulnerabilityEdge: CreateGcpApplicationFirstPartyVulnerabilityPayload_gcpApplicationFirstPartyVulnerabilityEdgePlan,
      query: queryPlan
    }
  },
  CreateGcpApplicationPayload: {
  ...
  CreateGcpApplicationThirdPartyVulnerabilityPayload: {
    ...
    plans: {
      clientMutationId: getClientMutationIdForCreatePlan,
      gcpApplicationThirdPartyVulnerability: planCreatePayloadResult,
      gcpApplicationThirdPartyVulnerabilityEdge: CreateGcpApplicationThirdPartyVulnerabilityPayload_gcpApplicationThirdPartyVulnerabilityEdgePlan,
      query: queryPlan
    }
  },
  CreateLogEntryPayload: {
  ...
  CreatePriorityPayload: {
    ...
    plans: {
      clientMutationId: getClientMutationIdForCreatePlan,
      priority: planCreatePayloadResult,
      priorityEdge: CreatePriorityPayload_priorityEdgePlan,
      query: queryPlan
    }
  },
  CreateRelationalItemRelationCompositePkPayload: {
  ...
  GcpApplicationFirstPartyVulnerability: {
    ...
    plans: {
      firstPartyVulnerabilityByFirstPartyVulnerabilityId: AwsApplicationFirstPartyVulnerability_firstPartyVulnerabilityByFirstPartyVulnerabilityIdPlan,
      firstPartyVulnerabilityId: AwsApplicationFirstPartyVulnerability_firstPartyVulnerabilityIdPlan,
      gcpApplicationByGcpApplicationId: GcpApplicationFirstPartyVulnerability_gcpApplicationByGcpApplicationIdPlan,
      gcpApplicationId: GcpApplicationFirstPartyVulnerability_gcpApplicationIdPlan
    },
    planType($specifier) {
      const spec = Object.create(null);
      for (const pkCol of gcp_application_first_party_vulnerabilitiesUniques[0].attributes) {
        spec[pkCol] = get2($specifier, pkCol);
      }
      return otherSource_gcp_application_first_party_vulnerabilitiesPgResource.get(spec);
    }
  },
  GcpApplicationFirstPartyVulnerabilityConnection: {
    assertStep: ConnectionStep,
  ...
  GcpApplicationThirdPartyVulnerability: {
    ...
    planType($specifier) {
      const spec = Object.create(null);
      for (const pkCol of gcp_application_third_party_vulnerabilitiesUniques[0].attributes) {
        spec[pkCol] = get2($specifier, pkCol);
      }
      return otherSource_gcp_application_third_party_vulnerabilitiesPgResource.get(spec);
    }
  },
  GcpApplicationThirdPartyVulnerabilityConnection: {
    assertStep: ConnectionStep,
...
export const inputObjects = {
  ApplicationCondition: {
    plans: {
      lastDeployed: ApplicationCondition_lastDeployedApply,
      name: ApplicationCondition_nameApply,
      rowId: LogEntryCondition_rowIdApply
    }
  },
  ...
  AwsApplicationFirstPartyVulnerabilityCondition: {
    plans: {
      awsApplicationId: AwsApplicationFirstPartyVulnerabilityCondition_awsApplicationIdApply,
      firstPartyVulnerabilityId: AwsApplicationFirstPartyVulnerabilityCondition_firstPartyVulnerabilityIdApply
    }
  },
  AwsApplicationFirstPartyVulnerabilityInput: {
    baked: createObjectAndApplyChildren,
    plans: {
      awsApplicationId: AwsApplicationFirstPartyVulnerabilityInput_awsApplicationIdApply,
      firstPartyVulnerabilityId: AwsApplicationFirstPartyVulnerabilityInput_firstPartyVulnerabilityIdApply
    }
  },
  ...
  AwsApplicationInput: {
    ...
    plans: {
      ...
      rowId: AwsApplicationInput_rowIdApply
    }
  },
  AwsApplicationPatch: {
    baked: createObjectAndApplyChildren,
  ...
  AwsApplicationThirdPartyVulnerabilityCondition: {
    plans: {
      awsApplicationId: AwsApplicationFirstPartyVulnerabilityCondition_awsApplicationIdApply,
      thirdPartyVulnerabilityId: AwsApplicationThirdPartyVulnerabilityCondition_thirdPartyVulnerabilityIdApply
    }
  },
  AwsApplicationThirdPartyVulnerabilityInput: {
    ...
    plans: {
      awsApplicationId: AwsApplicationFirstPartyVulnerabilityInput_awsApplicationIdApply,
      thirdPartyVulnerabilityId: AwsApplicationThirdPartyVulnerabilityInput_thirdPartyVulnerabilityIdApply
    }
  },
  ...
  CreateAwsApplicationFirstPartyVulnerabilityInput: {
    plans: {
      awsApplicationFirstPartyVulnerability: applyCreateFields,
  ...
  CreateAwsApplicationThirdPartyVulnerabilityInput: {
    plans: {
      awsApplicationThirdPartyVulnerability: applyCreateFields,
      clientMutationId: applyClientMutationIdForCreate
    }
  },
  ...
  CreateGcpApplicationFirstPartyVulnerabilityInput: {
    plans: {
      clientMutationId: applyClientMutationIdForCreate,
      gcpApplicationFirstPartyVulnerability: applyCreateFields
    }
  },
  ...
  CreateGcpApplicationThirdPartyVulnerabilityInput: {
    plans: {
      clientMutationId: applyClientMutationIdForCreate,
      gcpApplicationThirdPartyVulnerability: applyCreateFields
    }
  },
  CreateLogEntryInput: {
    plans: {
  ...
  GcpApplicationFirstPartyVulnerabilityCondition: {
    plans: {
      firstPartyVulnerabilityId: AwsApplicationFirstPartyVulnerabilityCondition_firstPartyVulnerabilityIdApply,
      gcpApplicationId: GcpApplicationFirstPartyVulnerabilityCondition_gcpApplicationIdApply
    }
  },
  GcpApplicationFirstPartyVulnerabilityInput: {
    ...
    plans: {
      firstPartyVulnerabilityId: AwsApplicationFirstPartyVulnerabilityInput_firstPartyVulnerabilityIdApply,
      gcpApplicationId: GcpApplicationFirstPartyVulnerabilityInput_gcpApplicationIdApply
    }
  },
  ...
  PriorityCondition: {
    plans: {
      rowId: LogEntryCondition_rowIdApply,
      title: PriorityCondition_titleApply
    }
  },
  PriorityInput: {
    baked: createObjectAndApplyChildren,
    plans: {
      rowId: AwsApplicationInput_rowIdApply,
      title: PriorityInput_titleApply
    }
  },
  PriorityPatch: {
    baked: createObjectAndApplyChildren,
  ...
  UpdateAwsApplicationFirstPartyVulnerabilityByAwsApplicationIdAndFirstPartyVulnerabilityIdInput: {
    plans: {
      awsApplicationFirstPartyVulnerabilityPatch: applyCreateFields,
      clientMutationId: applyClientMutationIdForCreate
    }
  },
  UpdateAwsApplicationThirdPartyVulnerabilityByAwsApplicationIdAndThirdPartyVulnerabilityIdInput: {
    plans: {
      awsApplicationThirdPartyVulnerabilityPatch: applyCreateFields,
      clientMutationId: applyClientMutationIdForCreate
    }
  },
  ...
  UpdateGcpApplicationFirstPartyVulnerabilityByGcpApplicationIdAndFirstPartyVulnerabilityIdInput: {
    plans: {
      clientMutationId: applyClientMutationIdForCreate,
      gcpApplicationFirstPartyVulnerabilityPatch: applyCreateFields
    }
  },
  UpdateGcpApplicationThirdPartyVulnerabilityByGcpApplicationIdAndThirdPartyVulnerabilityIdInput: {
    plans: {
      clientMutationId: applyClientMutationIdForCreate,
      gcpApplicationThirdPartyVulnerabilityPatch: applyCreateFields
    }
  },
  ...
  UpdatePriorityByRowIdInput: {
    plans: {
      clientMutationId: applyClientMutationIdForCreate,
      priorityPatch: applyCreateFields
    }
  },
...
export const enums = {
  ApplicationOrderBy: {
    values: {
      LAST_DEPLOYED_ASC: ApplicationOrderBy_LAST_DEPLOYED_ASCApply,
      LAST_DEPLOYED_DESC: ApplicationOrderBy_LAST_DEPLOYED_DESCApply,
      NAME_ASC: ApplicationOrderBy_NAME_ASCApply,
      NAME_DESC: ApplicationOrderBy_NAME_DESCApply,
      ROW_ID_ASC: ApplicationOrderBy_ROW_ID_ASCApply,
      ROW_ID_DESC: ApplicationOrderBy_ROW_ID_DESCApply
    }
  },
  AwsApplicationFirstPartyVulnerabilityOrderBy: {
    values: {
      AWS_APPLICATION_ID_ASC: AwsApplicationFirstPartyVulnerabilityOrderBy_AWS_APPLICATION_ID_ASCApply,
      AWS_APPLICATION_ID_DESC: AwsApplicationFirstPartyVulnerabilityOrderBy_AWS_APPLICATION_ID_DESCApply,
      FIRST_PARTY_VULNERABILITY_ID_ASC: AwsApplicationFirstPartyVulnerabilityOrderBy_FIRST_PARTY_VULNERABILITY_ID_ASCApply,
      FIRST_PARTY_VULNERABILITY_ID_DESC: AwsApplicationFirstPartyVulnerabilityOrderBy_FIRST_PARTY_VULNERABILITY_ID_DESCApply,
  ...
  AwsApplicationOrderBy: {
    values: {
      ...
      NAME_ASC: ApplicationOrderBy_NAME_ASCApply,
      NAME_DESC: ApplicationOrderBy_NAME_DESCApply,
      ORGANIZATION_ID_ASC: LogEntryOrderBy_ORGANIZATION_ID_ASCApply,
      ORGANIZATION_ID_DESC: LogEntryOrderBy_ORGANIZATION_ID_DESCApply,
      PERSON_ID_ASC: LogEntryOrderBy_PERSON_ID_ASCApply,
      PERSON_ID_DESC: LogEntryOrderBy_PERSON_ID_DESCApply,
      PRIMARY_KEY_ASC(queryBuilder) {
      ...
      ROW_ID_ASC: LogEntryOrderBy_ROW_ID_ASCApply,
      ROW_ID_DESC: LogEntryOrderBy_ROW_ID_DESCApply
    }
  },
  AwsApplicationThirdPartyVulnerabilityOrderBy: {
    values: {
      ...
      THIRD_PARTY_VULNERABILITY_ID_ASC: AwsApplicationThirdPartyVulnerabilityOrderBy_THIRD_PARTY_VULNERABILITY_ID_ASCApply,
      THIRD_PARTY_VULNERABILITY_ID_DESC: AwsApplicationThirdPartyVulnerabilityOrderBy_THIRD_PARTY_VULNERABILITY_ID_DESCApply
    }
  },
  CollectionOrderBy: {
    values: {
      ...
      CREATED_AT_ASC: SingleTableItemOrderBy_CREATED_AT_ASCApply,
      CREATED_AT_DESC: SingleTableItemOrderBy_CREATED_AT_DESCApply,
  ...
  FirstPartyVulnerabilityOrderBy: {
    values: {
      CVSS_SCORE_ASC: VulnerabilityOrderBy_CVSS_SCORE_ASCApply,
      CVSS_SCORE_DESC: VulnerabilityOrderBy_CVSS_SCORE_DESCApply,
      NAME_ASC: ApplicationOrderBy_NAME_ASCApply,
      NAME_DESC: ApplicationOrderBy_NAME_DESCApply,
      PRIMARY_KEY_ASC(queryBuilder) {
  ...
  GcpApplicationFirstPartyVulnerabilityOrderBy: {
    values: {
      FIRST_PARTY_VULNERABILITY_ID_ASC: AwsApplicationFirstPartyVulnerabilityOrderBy_FIRST_PARTY_VULNERABILITY_ID_ASCApply,
      FIRST_PARTY_VULNERABILITY_ID_DESC: AwsApplicationFirstPartyVulnerabilityOrderBy_FIRST_PARTY_VULNERABILITY_ID_DESCApply,
      GCP_APPLICATION_ID_ASC: GcpApplicationFirstPartyVulnerabilityOrderBy_GCP_APPLICATION_ID_ASCApply,
      GCP_APPLICATION_ID_DESC: GcpApplicationFirstPartyVulnerabilityOrderBy_GCP_APPLICATION_ID_DESCApply,
      PRIMARY_KEY_ASC(queryBuilder) {
  ...
  PriorityOrderBy: {
    values: {
      ...
      ROW_ID_ASC: LogEntryOrderBy_ROW_ID_ASCApply,
      ROW_ID_DESC: LogEntryOrderBy_ROW_ID_DESCApply,
      TITLE_ASC: PriorityOrderBy_TITLE_ASCApply,
      TITLE_DESC: PriorityOrderBy_TITLE_DESCApply
    }
  },
  RelationalChecklistItemOrderBy: {
    values: {
      ...
      ARCHIVED_AT_DESC: SingleTableItemOrderBy_ARCHIVED_AT_DESCApply,
      ...
      AUTHOR_ID_DESC: SingleTableItemOrderBy_AUTHOR_ID_DESCApply,
      ...
      CREATED_AT_DESC: SingleTableItemOrderBy_CREATED_AT_DESCApply,
      DESCRIPTION_ASC: RelationalChecklistItemOrderBy_DESCRIPTION_ASCApply,
      DESCRIPTION_DESC: RelationalChecklistItemOrderBy_DESCRIPTION_DESCApply,
      ...
      IS_EXPLICITLY_ARCHIVED_DESC: SingleTableItemOrderBy_IS_EXPLICITLY_ARCHIVED_DESCApply,
      NOTE_ASC: RelationalChecklistItemOrderBy_NOTE_ASCApply,
      NOTE_DESC: RelationalChecklistItemOrderBy_NOTE_DESCApply,
      ...
      PARENT_ID_DESC: SingleTableItemOrderBy_PARENT_ID_DESCApply,
      ...
      POSITION_DESC: SingleTableItemOrderBy_POSITION_DESCApply,
      PRIMARY_KEY_ASC(queryBuilder) {
      ...
      ROOT_TOPIC_ID_DESC: SingleTableItemOrderBy_ROOT_TOPIC_ID_DESCApply,
      ...
      UPDATED_AT_DESC: SingleTableItemOrderBy_UPDATED_AT_DESCApply
    }
  },
  ...
  RelationalItemOrderBy: {
    values: {
      ARCHIVED_AT_ASC: SingleTableItemOrderBy_ARCHIVED_AT_ASCApply,
      ARCHIVED_AT_DESC: SingleTableItemOrderBy_ARCHIVED_AT_DESCApply,
      AUTHOR_ID_ASC: SingleTableItemOrderBy_AUTHOR_ID_ASCApply,
      AUTHOR_ID_DESC: SingleTableItemOrderBy_AUTHOR_ID_DESCApply,
      CREATED_AT_ASC: SingleTableItemOrderBy_CREATED_AT_ASCApply,
      CREATED_AT_DESC: SingleTableItemOrderBy_CREATED_AT_DESCApply,
      IS_EXPLICITLY_ARCHIVED_ASC: SingleTableItemOrderBy_IS_EXPLICITLY_ARCHIVED_ASCApply,
      IS_EXPLICITLY_ARCHIVED_DESC: SingleTableItemOrderBy_IS_EXPLICITLY_ARCHIVED_DESCApply,
      PARENT_ID_ASC: SingleTableItemOrderBy_PARENT_ID_ASCApply,
      PARENT_ID_DESC: SingleTableItemOrderBy_PARENT_ID_DESCApply,
      POSITION_ASC: SingleTableItemOrderBy_POSITION_ASCApply,
      POSITION_DESC: SingleTableItemOrderBy_POSITION_DESCApply,
      PRIMARY_KEY_ASC(queryBuilder) {
      ...
      ROOT_TOPIC_ID_ASC: SingleTableItemOrderBy_ROOT_TOPIC_ID_ASCApply,
      ROOT_TOPIC_ID_DESC: SingleTableItemOrderBy_ROOT_TOPIC_ID_DESCApply,
      ROW_ID_ASC: LogEntryOrderBy_ROW_ID_ASCApply,
      ROW_ID_DESC: LogEntryOrderBy_ROW_ID_DESCApply,
      UPDATED_AT_ASC: SingleTableItemOrderBy_UPDATED_AT_ASCApply,
      UPDATED_AT_DESC: SingleTableItemOrderBy_UPDATED_AT_DESCApply
    }
  },
  RelationalItemRelationCompositePkOrderBy: {
    values: {
      CHILD_ID_ASC: SingleTableItemRelationOrderBy_CHILD_ID_ASCApply,
      CHILD_ID_DESC: SingleTableItemRelationOrderBy_CHILD_ID_DESCApply,
      PARENT_ID_ASC: SingleTableItemRelationOrderBy_PARENT_ID_ASCApply,
      PARENT_ID_DESC: SingleTableItemRelationOrderBy_PARENT_ID_DESCApply,
      PRIMARY_KEY_ASC(queryBuilder) {
