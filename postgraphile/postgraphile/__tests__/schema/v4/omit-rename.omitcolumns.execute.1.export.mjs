import { PgDeleteSingleStep, PgExecutor, PgResource, PgSelectStep, PgUnionAllStep, TYPES, assertPgClassSingleStep, makeRegistry, pgDeleteSingle, pgInsertSingle, pgSelectFromRecord, pgUpdateSingle, recordCodec, sqlFromArgDigests } from "@dataplan/pg";
...
export const plans = {
  ...
  Mutation: {
    ...
    login: {
      plan($root, args, _info) {
        const selectArgs = makeArgs4(args, ["input"]);
