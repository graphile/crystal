...
const FilmCondition_codeApply = ($condition, val) => applyAttributeCondition("code", TYPES.int, $condition, val);
const FilmCondition_titleApply = ($condition, val) => applyAttributeCondition("title", TYPES.varchar, $condition, val);
const FilmsOrderBy_CODE_ASCApply = queryBuilder => {
...
const FilmsOrderBy_CODE_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "code",
    direction: "DESC"
  });
...
const FilmsOrderBy_TITLE_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "title",
    direction: "ASC"
  });
};
const FilmsOrderBy_TITLE_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "title",
    direction: "DESC"
  });
};
const StudioCondition_idApply = ($condition, val) => applyAttributeCondition("id", TYPES.int, $condition, val);
const StudiosOrderBy_ID_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "id",
    direction: "ASC"
  });
...
const StudiosOrderBy_ID_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "id",
    direction: "DESC"
  });
...
export const objects = {
  ...
  Mutation: {
    ...
    plans: {
      ...
      deleteFilm: {
        plan(_$root, args) {
          const $delete = pgDeleteSingle(resource_filmsPgResource, specFromArgs_Film(args));
          args.apply($delete);
          return object({
            result: $delete
          });
...
export const inputObjects = {
  ...
  FilmCondition: {
    plans: {
      code: FilmCondition_codeApply,
      title: FilmCondition_titleApply
    }
  },
  FilmInput: {
...
export const enums = {
  FilmsOrderBy: {
    values: {
      CODE_ASC: FilmsOrderBy_CODE_ASCApply,
      CODE_DESC: FilmsOrderBy_CODE_DESCApply,
      ...
      TITLE_ASC: FilmsOrderBy_TITLE_ASCApply,
      TITLE_DESC: FilmsOrderBy_TITLE_DESCApply
    }
  },
  PeopleOrderBy: {
    values: {
      ...
      ID_ASC: StudiosOrderBy_ID_ASCApply,
      ID_DESC: StudiosOrderBy_ID_DESCApply,
