...
const TvShowsOrderBy_TITLE_ASCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "title",
    direction: "ASC"
  });
};
const TvShowsOrderBy_TITLE_DESCApply = queryBuilder => {
  queryBuilder.orderBy({
    attribute: "title",
    direction: "DESC"
  });
...
export const enums = {
  FilmsOrderBy: {
    values: {
      ...
      TITLE_ASC: TvShowsOrderBy_TITLE_ASCApply,
      TITLE_DESC: TvShowsOrderBy_TITLE_DESCApply
    }
  },
  PeopleOrderBy: {
    values: {
