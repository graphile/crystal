...
const housesUniques = [{
  ...
  isPrimary: false,
  attributes: ["street_name", "property_id"],
  description: undefined,
  extensions: {
    tags: {
      __proto__: null
  ...
  isPrimary: false,
  attributes: ["street_id", "property_name_or_number"],
  description: undefined,
  extensions: {
    tags: {
      __proto__: null
  ...
  isPrimary: false,
  attributes: ["street_name", "building_name"],
  description: undefined,
  extensions: {
    tags: {
      __proto__: null
...
type Query implements Node {
  ...
  """Get a single \`House\`."""
  houseByStreetNameAndPropertyId(streetName: String!, propertyId: Int!): House

  """Get a single \`House\`."""
  houseByStreetIdAndPropertyNameOrNumber(streetId: Int!, propertyNameOrNumber: String!): House

  """Get a single \`House\`."""
  houseByStreetNameAndBuildingName(streetName: String!, buildingName: String!): House
...
export const plans = {
  Query: {
    ...
    houseByStreetNameAndPropertyId(_$root, args) {
      return pgResource_housesPgResource.get({
        street_name: args.getRaw("streetName"),
        property_id: args.getRaw("propertyId")
      });
    },
    houseByStreetIdAndPropertyNameOrNumber(_$root, args) {
      return pgResource_housesPgResource.get({
        street_id: args.getRaw("streetId"),
        property_name_or_number: args.getRaw("propertyNameOrNumber")
      });
    },
    houseByStreetNameAndBuildingName(_$root, args) {
      return pgResource_housesPgResource.get({
        street_name: args.getRaw("streetName"),
        building_name: args.getRaw("buildingName")
      });
    },
