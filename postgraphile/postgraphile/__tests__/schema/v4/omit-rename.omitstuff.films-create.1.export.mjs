...
const UpdateFilmPayload_filmEdgePlan = ($mutation, fieldArgs) => pgMutationPayloadEdge(resource_filmsPgResource, filmsUniques[0].attributes, $mutation, fieldArgs);
...
export const objects = {
  ...
  DeleteFilmPayload: {
    ...
    plans: {
      ...
      filmEdge: UpdateFilmPayload_filmEdgePlan,
      query: queryPlan
    }
  },
  DeletePersonPayload: {
