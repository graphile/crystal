...
const makeArgs_code__buildings = () => EMPTY_ARRAY;
const resource_code__buildingsPgResource = registry.pgResources["code__buildings"];
...
const resource_age__buildingsPgResource = registry.pgResources["age__buildings"];
const resource_code__petsPgResource = registry.pgResources["code__pets"];
const resource_age__petsPgResource = registry.pgResources["age__pets"];
...
export const objects = {
  ...
  Building: {
    ...
    plans: {
      age($in, args, _info) {
        return scalarComputed(resource_age__buildingsPgResource, $in, makeArgs_code__buildings(args));
      },
      code($in, args, _info) {
        return scalarComputed(resource_code__buildingsPgResource, $in, makeArgs_code__buildings(args));
      },
      nodeId($parent) {
  ...
  Pet: {
    ...
    plans: {
      age($in, args, _info) {
        return scalarComputed(resource_age__petsPgResource, $in, makeArgs_code__buildings(args));
      },
      code($in, args, _info) {
        return scalarComputed(resource_code__petsPgResource, $in, makeArgs_code__buildings(args));
      },
      nodeId($parent) {
