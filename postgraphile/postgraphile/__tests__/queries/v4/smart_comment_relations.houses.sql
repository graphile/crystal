...
select
  ...
  (select json_agg(_) from (
    select
      __buildings_5."name" as "0",
      __buildings_5."id"::text as "1"
    from "smart_comment_relations"."buildings" as __buildings_5
    where (
      __streets_5."name"::"text" = __buildings_5."name"
    )
    order by __buildings_5."id" asc
  ) _) as "24",
  __streets_5."name" as "25",
  __streets_5."id"::text as "26",
  __buildings_6."is_primary"::text as "27",
  __buildings_6."floors"::text as "28",
  __buildings_6."name" as "29",
  __buildings_6."id"::text as "30",
  (select json_agg(_) from (
    select
  ...
  __streets_6."name" as "32",
  __streets_6."id"::text as "33",
  __houses__."building_id"::text as "34",
  __houses__."street_name" as "35",
  __houses__."property_name_or_number" as "36",
  __houses__."building_name" as "37",
  __houses__."property_id"::text as "38",
  __houses__."street_id"::text as "39"
from "smart_comment_relations"."houses" as __houses__
...
left outer join "smart_comment_relations"."buildings" as __buildings_6
on (__houses__."building_id"::"int4" = __buildings_6."id")
left outer join "smart_comment_relations"."properties" as __properties_3
on (__buildings_6."property_id"::"int4" = __properties_3."id")
...
on (__buildings_6."name"::"text" = __streets_5."name")
