...
select
  ...
  __post_3."id"::text as "102",
  __post_3."headline" as "103",
  __post_4."id"::text as "104",
  ...
  __frmcdc_nested_compound_type_3."baz_buz"::text as "114",
  (not (__frmcdc_nested_compound_type_3 is null))::text as "115",
  __frmcdc_compound_type_8."a"::text as "116",
  __frmcdc_compound_type_8."b" as "117",
  __frmcdc_compound_type_8."c"::text as "118",
  __frmcdc_compound_type_8."d" as "119",
  __frmcdc_compound_type_8."e"::text as "120",
  __frmcdc_compound_type_8."f"::text as "121",
  __frmcdc_compound_type_8."foo_bar"::text as "122",
  (not (__frmcdc_compound_type_8 is null))::text as "123",
  __frmcdc_compound_type_9."a"::text as "124",
  __frmcdc_compound_type_9."b" as "125",
  __frmcdc_compound_type_9."c"::text as "126",
  __frmcdc_compound_type_9."d" as "127",
  __frmcdc_compound_type_9."e"::text as "128",
  __frmcdc_compound_type_9."f"::text as "129",
  __frmcdc_compound_type_9."foo_bar"::text as "130",
  (not (__frmcdc_compound_type_9 is null))::text as "131",
  ...
  __frmcdc_nested_compound_type_4."baz_buz"::text as "140",
  (not (__frmcdc_nested_compound_type_4 is null))::text as "141",
  __frmcdc_compound_type_11."a"::text as "142",
  __frmcdc_compound_type_11."b" as "143",
  __frmcdc_compound_type_11."c"::text as "144",
  __frmcdc_compound_type_11."d" as "145",
  __frmcdc_compound_type_11."e"::text as "146",
  __frmcdc_compound_type_11."f"::text as "147",
  __frmcdc_compound_type_11."foo_bar"::text as "148",
  (not (__frmcdc_compound_type_11 is null))::text as "149",
  __frmcdc_compound_type_12."a"::text as "150",
  __frmcdc_compound_type_12."b" as "151",
  __frmcdc_compound_type_12."c"::text as "152",
  __frmcdc_compound_type_12."d" as "153",
  __frmcdc_compound_type_12."e"::text as "154",
  __frmcdc_compound_type_12."f"::text as "155",
  __frmcdc_compound_type_12."foo_bar"::text as "156",
  (not (__frmcdc_compound_type_12 is null))::text as "157"
from "b"."types" as __types__
...
select
  ...
  __post_2."id"::text as "47",
  __post_2."headline" as "48",
  __post_3."id"::text as "49",
  __post_3."headline" as "50",
