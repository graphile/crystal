...
select
  ...
  __frmcdc_compound_type_7."a"::text as "51",
  __frmcdc_compound_type_7."b" as "52",
  __frmcdc_compound_type_7."c"::text as "53",
  __frmcdc_compound_type_7."d" as "54",
  __frmcdc_compound_type_7."e"::text as "55",
  __frmcdc_compound_type_7."f"::text as "56",
  __frmcdc_compound_type_7."foo_bar"::text as "57",
  (not (__frmcdc_compound_type_7 is null))::text as "58",
  __frmcdc_nested_compound_type_3."baz_buz"::text as "59",
  (not (__frmcdc_nested_compound_type_3 is null))::text as "60",
  __frmcdc_compound_type_8."a"::text as "61",
  __frmcdc_compound_type_8."b" as "62",
  __frmcdc_compound_type_8."c"::text as "63",
  __frmcdc_compound_type_8."d" as "64",
  __frmcdc_compound_type_8."e"::text as "65",
  __frmcdc_compound_type_8."f"::text as "66",
  __frmcdc_compound_type_8."foo_bar"::text as "67",
  (not (__frmcdc_compound_type_8 is null))::text as "68",
  __frmcdc_compound_type_9."a"::text as "69",
  __frmcdc_compound_type_9."b" as "70",
  __frmcdc_compound_type_9."c"::text as "71",
  __frmcdc_compound_type_9."d" as "72",
  __frmcdc_compound_type_9."e"::text as "73",
  __frmcdc_compound_type_9."f"::text as "74",
  __frmcdc_compound_type_9."foo_bar"::text as "75",
  (not (__frmcdc_compound_type_9 is null))::text as "76",
  __frmcdc_compound_type_10."a"::text as "77",
  __frmcdc_compound_type_10."b" as "78",
  __frmcdc_compound_type_10."c"::text as "79",
  __frmcdc_compound_type_10."d" as "80",
  __frmcdc_compound_type_10."e"::text as "81",
  __frmcdc_compound_type_10."f"::text as "82",
  __frmcdc_compound_type_10."foo_bar"::text as "83",
  (not (__frmcdc_compound_type_10 is null))::text as "84",
  __frmcdc_nested_compound_type_4."baz_buz"::text as "85",
  (not (__frmcdc_nested_compound_type_4 is null))::text as "86",
  __frmcdc_compound_type_11."a"::text as "87",
  __frmcdc_compound_type_11."b" as "88",
  __frmcdc_compound_type_11."c"::text as "89",
  __frmcdc_compound_type_11."d" as "90",
  __frmcdc_compound_type_11."e"::text as "91",
  __frmcdc_compound_type_11."f"::text as "92",
  __frmcdc_compound_type_11."foo_bar"::text as "93",
  (not (__frmcdc_compound_type_11 is null))::text as "94",
  __frmcdc_compound_type_12."a"::text as "95",
  __frmcdc_compound_type_12."b" as "96",
  __frmcdc_compound_type_12."c"::text as "97",
  __frmcdc_compound_type_12."d" as "98",
  __frmcdc_compound_type_12."e"::text as "99",
  __frmcdc_compound_type_12."f"::text as "100",
  __frmcdc_compound_type_12."foo_bar"::text as "101",
  (not (__frmcdc_compound_type_12 is null))::text as "102",
  array(
    select array[
      __types_2."id"::text,
    ...
    left outer join lateral (select (__types_2."compound_type").*) as __frmcdc_compound_type__
    on TRUE
    left outer join lateral (select (__types_2."nested_compound_type").*) as __frmcdc_nested_compound_type__
    on TRUE
    left outer join lateral (select (__frmcdc_nested_compound_type__."a").*) as __frmcdc_compound_type_2
    on TRUE
    left outer join lateral (select (__frmcdc_nested_compound_type__."b").*) as __frmcdc_compound_type_3
    on TRUE
    left outer join lateral (select (__types_2."nullable_compound_type").*) as __frmcdc_compound_type_4
    on TRUE
    left outer join lateral (select (__types_2."nullable_nested_compound_type").*) as __frmcdc_nested_compound_type_2
    on TRUE
    left outer join lateral (select (__frmcdc_nested_compound_type_2."a").*) as __frmcdc_compound_type_5
    on TRUE
    left outer join lateral (select (__frmcdc_nested_compound_type_2."b").*) as __frmcdc_compound_type_6
