  ...
  select
    ...
    (select json_agg(s) from (
      select
        ...
        __frmcdc_compound_type_19."b" as "107",
        __frmcdc_compound_type_19."c"::text as "108",
        __frmcdc_compound_type_19."d" as "109",
        __frmcdc_compound_type_19."e"::text as "110",
        __frmcdc_compound_type_19."f"::text as "111",
        __frmcdc_compound_type_19."foo_bar"::text as "112",
        (not (__frmcdc_compound_type_19 is null))::text as "113",
        __frmcdc_compound_type_20."a"::text as "114",
        __frmcdc_compound_type_20."b" as "115",
        __frmcdc_compound_type_20."c"::text as "116",
        __frmcdc_compound_type_20."d" as "117",
        __frmcdc_compound_type_20."e"::text as "118",
        __frmcdc_compound_type_20."f"::text as "119",
        __frmcdc_compound_type_20."foo_bar"::text as "120",
        (not (__frmcdc_compound_type_20 is null))::text as "121",
        __frmcdc_compound_type_21."a"::text as "122",
        __frmcdc_compound_type_21."b" as "123",
        __frmcdc_compound_type_21."c"::text as "124",
        __frmcdc_compound_type_21."d" as "125",
        __frmcdc_compound_type_21."e"::text as "126",
        __frmcdc_compound_type_21."f"::text as "127",
        __frmcdc_compound_type_21."foo_bar"::text as "128",
        (not (__frmcdc_compound_type_21 is null))::text as "129",
        __frmcdc_nested_compound_type_7."baz_buz"::text as "130",
        (not (__frmcdc_nested_compound_type_7 is null))::text as "131",
        __frmcdc_compound_type_22."a"::text as "132",
        __frmcdc_compound_type_22."b" as "133",
        __frmcdc_compound_type_22."c"::text as "134",
        __frmcdc_compound_type_22."d" as "135",
        __frmcdc_compound_type_22."e"::text as "136",
        __frmcdc_compound_type_22."f"::text as "137",
        __frmcdc_compound_type_22."foo_bar"::text as "138",
        (not (__frmcdc_compound_type_22 is null))::text as "139",
        __frmcdc_compound_type_23."a"::text as "140",
        __frmcdc_compound_type_23."b" as "141",
        __frmcdc_compound_type_23."c"::text as "142",
        __frmcdc_compound_type_23."d" as "143",
        __frmcdc_compound_type_23."e"::text as "144",
        __frmcdc_compound_type_23."f"::text as "145",
        __frmcdc_compound_type_23."foo_bar"::text as "146",
        (not (__frmcdc_compound_type_23 is null))::text as "147",
        __frmcdc_compound_type_24."a"::text as "148",
        __frmcdc_compound_type_24."b" as "149",
        __frmcdc_compound_type_24."c"::text as "150",
        __frmcdc_compound_type_24."d" as "151",
        __frmcdc_compound_type_24."e"::text as "152",
        __frmcdc_compound_type_24."f"::text as "153",
        __frmcdc_compound_type_24."foo_bar"::text as "154",
        (not (__frmcdc_compound_type_24 is null))::text as "155",
        __frmcdc_nested_compound_type_8."baz_buz"::text as "156",
        (not (__frmcdc_nested_compound_type_8 is null))::text as "157",
        (row_number() over (partition by 1))::text as "158"
