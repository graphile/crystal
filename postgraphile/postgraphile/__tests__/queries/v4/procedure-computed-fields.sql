select
  ("c"."compound_type_computed_field"(__frmcdc_compound_type_1__))::text as "0",
  ...
  ("c"."compound_type_computed_field"(__frmcdc_compound_type_1_2))::text as "4",
  __frmcdc_compound_type_1_2."foo_bar"::text as "5",
  __frmcdc_compound_type_1_2."a"::text as "6",
  (not (__frmcdc_compound_type_1_2 is null))::text as "7",
  (not (__frmcdc_nested_compound_type_1__ is null))::text as "8",
  ("c"."compound_type_computed_field"(__frmcdc_compound_type_1_3))::text as "9",
  __frmcdc_compound_type_1_3."foo_bar"::text as "10",
  __frmcdc_compound_type_1_3."a"::text as "11",
  (not (__frmcdc_compound_type_1_3 is null))::text as "12",
  ("c"."compound_type_computed_field"(__frmcdc_compound_type_1_4))::text as "13",
  __frmcdc_compound_type_1_4."foo_bar"::text as "14",
  __frmcdc_compound_type_1_4."a"::text as "15",
  (not (__frmcdc_compound_type_1_4 is null))::text as "16",
  ("c"."compound_type_computed_field"(__frmcdc_compound_type_1_5))::text as "17",
  __frmcdc_compound_type_1_5."foo_bar"::text as "18",
  __frmcdc_compound_type_1_5."a"::text as "19",
  (not (__frmcdc_compound_type_1_5 is null))::text as "20",
  (not (__frmcdc_nested_compound_type_1_2 is null))::text as "21",
  ("c"."compound_type_computed_field"(__frmcdc_compound_type_1_6))::text as "22",
  __frmcdc_compound_type_1_6."foo_bar"::text as "23",
  __frmcdc_compound_type_1_6."a"::text as "24",
  (not (__frmcdc_compound_type_1_6 is null))::text as "25",
