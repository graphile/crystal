...
lateral (
  select
    __similar_table1__."col3"::text as "0",
    __similar_table1__."col2"::text as "1",
    __similar_table1__."col1"::text as "2",
    __similar_table1__."id"::text as "3",
...
lateral (
  select
    __similar_table2__."col5"::text as "0",
    __similar_table2__."col4"::text as "1",
    __similar_table2__."col3"::text as "2",
    __similar_table2__."id"::text as "3",
