select
  ...
  __person_secret__."person_id"::text as "4",
  __left_arm__."length_in_metres"::text as "5",
  "c"."person_first_name"(__person_2) as "6",
  __person_2."person_full_name" as "7",
  __person_2."id"::text as "8",
  __left_arm__."person_id"::text as "9",
  __left_arm__."id"::text as "10",
  "c"."person_first_name"(__person_3) as "11",
...
on (__person_secret__."person_id"::"int4" = __person__."id")
