...
lateral (
  select
    ...
    __frmcdc_compound_type_1__."a"::text as "5",
    (not (__frmcdc_compound_type_1__ is null))::text as "6",
    __func_out_complex__."x"::text as "7",
...
lateral (
  select
    ...
    __func_out_out_compound_type__."o1"::text as "4",
...
lateral (
  select
    ...
    (not (__person_computed_first_arg_inout_out__ is null))::text as "11",
    ...
    __person_3."person_full_name" as "15",
    __person_3."id"::text as "16",
    __frmcdc_compound_type_1__."c"::text as "17",
    __frmcdc_compound_type_1__."b" as "18",
    __frmcdc_compound_type_1__."a"::text as "19",
    (not (__frmcdc_compound_type_1__ is null))::text as "20",
    __person_computed_complex__."x"::text as "21",
    (not (__person_computed_complex__ is null))::text as "22",
    __person__."person_full_name" as "23",
    __person__."id"::text as "24",
...
lateral (
  select
    ...
    __frmcdc_compound_type_1__."a"::text as "5",
    (not (__frmcdc_compound_type_1__ is null))::text as "6",
    __func_out_complex_setof__."x"::text as "7",
