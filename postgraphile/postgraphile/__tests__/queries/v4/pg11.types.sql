select
  ...
  __frmcdc_domain_constrained_compound_type_1__."foo_bar"::text as "1",
  __frmcdc_domain_constrained_compound_type_1__."f"::text as "2",
  __frmcdc_domain_constrained_compound_type_1__."e"::text as "3",
  __frmcdc_domain_constrained_compound_type_1__."d" as "4",
  __frmcdc_domain_constrained_compound_type_1__."c"::text as "5",
  __frmcdc_domain_constrained_compound_type_1__."b" as "6",
  __frmcdc_domain_constrained_compound_type_1__."a"::text as "7",
  (not (__frmcdc_domain_constrained_compound_type_1__ is null))::text as "8",
  __types__."bigint_domain_array_domain"::text as "9",
  __types__."regnamespace"::text as "10",
  __types__."regrole"::text as "11",
