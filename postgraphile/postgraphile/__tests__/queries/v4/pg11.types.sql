select
  ...
  __frmcdc_domain_constrained_compound_type_1_2."a"::text as "12",
  __frmcdc_domain_constrained_compound_type_1_2."b" as "13",
  __frmcdc_domain_constrained_compound_type_1_2."c"::text as "14",
  __frmcdc_domain_constrained_compound_type_1_2."d" as "15",
  __frmcdc_domain_constrained_compound_type_1_2."e"::text as "16",
  __frmcdc_domain_constrained_compound_type_1_2."f"::text as "17",
  __frmcdc_domain_constrained_compound_type_1_2."foo_bar"::text as "18",
