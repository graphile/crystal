...
from (
    ...
    from (
      ...
      where __aws_application_first_party_vulnerabilities__."aws_application_id" = $1::"int4"
      order by
        __first_party_vulnerabilities__."id" asc
      limit 2
    ) as __first_party_vulnerabilities__
  union all
    ...
    from (
      ...
      where __aws_application_third_party_vulnerabilities__."aws_application_id" = $2::"int4"
      order by
        __third_party_vulnerabilities__."id" asc
      limit 2
    ) as __third_party_vulnerabilities__
