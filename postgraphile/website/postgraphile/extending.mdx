...
:::tip[Start with `extendSchema()`]

If you just want to add a few specific fields or types to your schema from
JavaScript/TypeScript, [`extendSchema()`](./extend-schema) will get you there
quickly using GraphQL's ergonomic type extension SDL and Gra*fast*'s plan
resolvers.

If, however, you want to make more far-reaching programatic changes to your
schema, read on.
