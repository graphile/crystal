...
- [Polymorphism support](../polymorphism), both in the engine and for Postgres autogeneration
...
- [New "behavior" system](../behavior) allows more precise control over how schema is generated
...
See ["Exporting your schema"](../exporting-schema) for more information.
