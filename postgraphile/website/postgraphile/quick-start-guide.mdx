...
You need to be running Node.js 22 or higher to run PostGraphile, and we
recommend Node.js 24 or higher. You can check your current version of Node by
running `node --version`. If you're running a recent version you can skip this
section.
...
22.0.0 or higher; 24.0.0 or higher is recommended.

### Install PostgreSQL

We need a PostgreSQL database to connect to. You can skip this section if you
already have PostgreSQL version `14.0` or higher installed. If you do not use a
...
TypeScript, in the [Configuration documentation](./config/index.mdx).)
