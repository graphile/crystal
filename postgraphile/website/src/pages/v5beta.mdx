...
Four major issues have been outlined which need to be addressed before a general release of PostGraphile Version 5. These milestones are actually for Gra*fast*, the new execution engine upon which PostGraphile Version 5 has been built.
The first three of the issues have now been reached, hurrah!
...
- Smaller issues outside of the above milestones are listed in the [V5 Project Board](https://github.com/orgs/graphile/projects/3) on GitHub. This board is dynamic, new issues get shown here and some of the tasks are &ldquo;nice to haves&rdquo; while others may be migrated to a V5.1 or later release.
...
<tr>
  ...
  <td>beta.40</td>
  <td>
    Eradicating eval milestone reached.{" "}
...
<tr>
  <td>2024-05-09</td>
  <td>beta.22</td>
  <td>Early exit and global dependencies milestones reached</td>
</tr>
