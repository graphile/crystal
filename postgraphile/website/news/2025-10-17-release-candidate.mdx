...
After five and a half years of work, 38 canaries, 20 alphas, 49 betas, and 4
Gra*fast* epics, PostGraphile V5 has finally reached **release candidate**
status. Assuming no issues are found, this software, these APIs, are what will
make up the final PostGraphile v5.0.0 release! The runtime is ready, many of you
are already using it in production, but the types and docs are a little behind.
Help us get ready for release: try it out, tell us where the gaps are, and maybe
help fill them!
...
would ultimately become PostGraphile V5 and the [Gra*fast* execution
...
- ✅ "Everything is batched" now makes ergonomic accommodations for "unary"
  values (variables, context, etc).
