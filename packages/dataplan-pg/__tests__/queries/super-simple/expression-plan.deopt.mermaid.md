...
graph TD
    ...
    PgClassExpression_26["PgClassExpression[_26∈1]<br /><__forums__...ll is true>"]:::plan
    ...
    Bucket1("Bucket 1 (item_21)<br />Deps: _17<br />~>Query.forums[]<br />⠀ROOT <-O- _22<br />⠀⠀name <-L- _23<br />⠀⠀archivedAtIsNotNull <-L- _26"):::bucket
