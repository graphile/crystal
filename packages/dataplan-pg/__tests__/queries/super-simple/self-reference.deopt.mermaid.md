...
graph TD
    ...
    PgClassExpression24["PgClassExpression[24∈1]<br />ᐸ__forums__.”id”ᐳ"]:::plan
    ...
    P17["ᐳforums"]
    PgSelect17 -.-> P17
    P22["ᐳforums[]<br />ᐳf…]ᐳself"]
    PgSelectSingle22 -.-> P22
    P23["ᐳf…]ᐳname<br />ᐳf…]ᐳselfᐳname"]
    ...
    Bucket1("Bucket 1 (item21)<br />Deps: 17<br />~ᐳQuery.forums[]<br />⠀ROOT ᐸ-O- 22<br />⠀⠀self ᐸ-O- 22<br />⠀⠀⠀self.name ᐸ-L- 23<br />⠀⠀⠀self.id ᐸ-L- 24<br />⠀⠀name ᐸ-L- 23"):::bucket
