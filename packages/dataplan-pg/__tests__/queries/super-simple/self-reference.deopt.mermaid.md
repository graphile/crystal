...
graph TD
    ...
    PgClassExpression_24["PgClassExpression[_24∈1]<br />ᐸ__forums__.”id”ᐳ"]:::plan
    ...
    P_17["ᐳforums"]
    PgSelect_17 -.-> P_17
    P_22["ᐳforums[]<br />ᐳf…]ᐳself"]
    PgSelectSingle_22 -.-> P_22
    P_23["ᐳf…]ᐳname<br />ᐳf…]ᐳselfᐳname"]
    ...
    Bucket1("Bucket 1 (item_21)<br />Deps: _17<br />~ᐳQuery.forums[]<br />⠀ROOT ᐸ-O- _22<br />⠀⠀self ᐸ-O- _22<br />⠀⠀⠀self.name ᐸ-L- _23<br />⠀⠀⠀self.id ᐸ-L- _24<br />⠀⠀name ᐸ-L- _23"):::bucket
