select
  ...
  array(
    select array[
      ...
      __relational_topics_3."title"::text,
      ...
      __relational_posts_3."title"::text,
      __relational_posts_3."description"::text,
      __relational_posts_3."note"::text,
      ...
      __relational_topics_4."title"::text,
      ...
      __relational_posts_4."title"::text,
      __relational_posts_4."description"::text,
      __relational_posts_4."note"::text,
      ...
      __relational_dividers_3."title"::text,
      __relational_dividers_3."color"::text,
      ...
      __relational_checklists_3."title"::text,
      ...
      __relational_checklist_items_3."description"::text,
      __relational_checklist_items_3."note"::text,
      ...
      __relational_dividers_4."title"::text,
      __relational_dividers_4."color"::text,
      ...
      __relational_topics_5."title"::text,
      ...
      __relational_posts_5."title"::text,
      __relational_posts_5."description"::text,
      __relational_posts_5."note"::text,
      ...
      __relational_dividers_5."title"::text,
      __relational_dividers_5."color"::text,
      ...
      __relational_checklists_4."title"::text,
      ...
      __relational_checklist_items_4."description"::text,
      __relational_checklist_items_4."note"::text,
      ...
      __relational_checklists_5."title"::text,
      ...
      __relational_topics_6."title"::text,
      ...
      __relational_posts_6."title"::text,
      __relational_posts_6."description"::text,
      __relational_posts_6."note"::text,
      ...
      __relational_dividers_6."title"::text,
      __relational_dividers_6."color"::text,
      ...
      __relational_checklists_6."title"::text,
      ...
      __relational_checklist_items_5."description"::text,
      __relational_checklist_items_5."note"::text,
      ...
      __relational_checklist_items_6."description"::text,
      __relational_checklist_items_6."note"::text,
