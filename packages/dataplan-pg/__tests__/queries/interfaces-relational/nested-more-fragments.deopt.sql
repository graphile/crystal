...
lateral (
  select
    ...
    to_char(__relational_items__."created_at", $2) as "6",
    to_char(__relational_items__."updated_at", $3) as "7",
    __relational_items__."is_explicitly_archived"::text as "8",
    to_char(__relational_items__."archived_at", $4) as "9",
...
lateral (
  select
    ...
    to_char(__relational_items__."created_at", $2) as "5",
    to_char(__relational_items__."updated_at", $3) as "6",
    __relational_items__."is_explicitly_archived"::text as "7",
    to_char(__relational_items__."archived_at", $4) as "8",
