select
  ...
  __relational_posts__."title"::text as "5",
  __relational_posts__."description"::text as "6",
  __relational_posts__."note"::text as "7",
  ...
  __relational_checklists__."title"::text as "12",
  ...
  __relational_checklist_items__."description"::text as "17",
  __relational_checklist_items__."note"::text as "18"
