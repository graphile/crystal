...
lateral (
  select
    ...
    __relational_items_2."created_at"::text as "11",
    __relational_items_2."updated_at"::text as "12",
    __relational_items_2."is_explicitly_archived"::text as "13",
    __relational_items_2."archived_at"::text as "14",
    __relational_posts__."id"::text as "15",
    __relational_posts__."title"::text as "16",
    __relational_posts__."description"::text as "17",
    __relational_posts__."note"::text as "18",
    __relational_items_3."type"::text as "19",
    __relational_items_3."position"::text as "20",
    __relational_items_3."created_at"::text as "21",
    __relational_items_3."updated_at"::text as "22",
    __relational_items_3."is_explicitly_archived"::text as "23",
    __relational_items_3."archived_at"::text as "24",
    __relational_dividers__."id"::text as "25",
    __relational_dividers__."title"::text as "26",
    __relational_dividers__."color"::text as "27",
    __relational_items_4."type"::text as "28",
    __relational_items_4."position"::text as "29",
    __relational_items_4."created_at"::text as "30",
    __relational_items_4."updated_at"::text as "31",
    __relational_items_4."is_explicitly_archived"::text as "32",
    __relational_items_4."archived_at"::text as "33",
    __relational_checklists__."id"::text as "34",
    __relational_checklists__."title"::text as "35",
    __relational_items_5."type"::text as "36",
    __relational_items_5."position"::text as "37",
    __relational_items_5."created_at"::text as "38",
    __relational_items_5."updated_at"::text as "39",
    __relational_items_5."is_explicitly_archived"::text as "40",
    __relational_items_5."archived_at"::text as "41",
    __relational_checklist_items__."id"::text as "42",
    __relational_checklist_items__."description"::text as "43",
    __relational_checklist_items__."note"::text as "44",
    __relational_items_6."id"::text as "45",
    __relational_items_identifiers__.idx as "46"
