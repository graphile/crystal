...
graph TD
    ...
    %% subgraph fields
    P1{{"~"}}:::path
    P2[/">featuredMessages"\]:::path
    P3>">featuredMessages[]"]:::path
    P2 -.- P3
    P4([">fe…s[]>body"]):::path
    %% P3 -.-> P4
    %% P1 -.-> P2
    ...
    PgClassExpression_13["PgClassExpression[_13∈1]<br /><__featured...s__.#quot;body#quot;>"]:::plan
    ...
    Bucket1("Bucket 1 (__Item[_11])<br />>featuredMessages[]"):::bucket
