select
  ...
  (select json_agg(_) from (
    select
      ...
      to_char(__single_table_items_2."created_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "14",
      to_char(__single_table_items_2."updated_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "15",
      __single_table_items_2."is_explicitly_archived"::text as "16",
      to_char(__single_table_items_2."archived_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "17"
