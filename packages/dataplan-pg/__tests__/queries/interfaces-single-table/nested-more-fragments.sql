select
  ...
  (select json_agg(_) from (
    select
      ...
      to_char(__single_table_items__."created_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "5",
      to_char(__single_table_items__."updated_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "6",
      __single_table_items__."is_explicitly_archived"::text as "7",
      to_char(__single_table_items__."archived_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "8",
      ...
      to_char(__single_table_items_2."created_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "18",
      to_char(__single_table_items_2."updated_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "19",
      __single_table_items_2."is_explicitly_archived"::text as "20",
      to_char(__single_table_items_2."archived_at", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM') as "21",
