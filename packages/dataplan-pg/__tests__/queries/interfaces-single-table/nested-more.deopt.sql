...
lateral (
  select
    ...
    to_char(__single_table_items__."created_at", $2) as "6",
    to_char(__single_table_items__."updated_at", $3) as "7",
    __single_table_items__."is_explicitly_archived"::text as "8",
    to_char(__single_table_items__."archived_at", $4) as "9",
...
lateral (
  select
    ...
    to_char(__single_table_items__."created_at", $2) as "4",
    to_char(__single_table_items__."updated_at", $3) as "5",
    __single_table_items__."is_explicitly_archived"::text as "6",
    to_char(__single_table_items__."archived_at", $4) as "7",
