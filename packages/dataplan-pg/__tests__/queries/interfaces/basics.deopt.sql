...
lateral (
  select
    ...
    __single_table_items__."created_at"::text as "2",
    __single_table_items__."updated_at"::text as "3",
    __single_table_items__."is_explicitly_archived"::text as "4",
    __single_table_items__."archived_at"::text as "5",
