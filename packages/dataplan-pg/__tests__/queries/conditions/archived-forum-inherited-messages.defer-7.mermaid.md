...
graph TD
    ...
    PgClassExpression_44["PgClassExpression[_44∈3@1] {2,3}<br /><__messages...author_id”>"]:::plan
    PgSelect_45[["PgSelect[_45∈3@1] {2,3}<br /><users>"]]:::plan
    First_49["First[_49∈3@1] {2,3}"]:::plan
    PgSelectSingle_50["PgSelectSingle[_50∈3@1] {2,3}<br /><users>"]:::plan
    PgClassExpression_51["PgClassExpression[_51∈3@1] {2,3}<br /><__users__.”username”>"]:::plan
    PgClassExpression_52["PgClassExpression[_52∈3@1] {2,3}<br /><__users__....vatar_url”>"]:::plan
    ...
    class __Value_0,__Value_3,PgSelect_17,Access_61,Access_62,Object_63 bucket0
    ...
    class __Item_41,PgSelectSingle_42,PgClassExpression_43,PgClassExpression_44,PgSelect_45,First_49,PgSelectSingle_50,PgClassExpression_51,PgClassExpression_52,PgCursor_55,PgClassExpression_56,List_57 bucket3
    ...
    Bucket0 --> Bucket1
    Bucket2("Bucket 2 (group1[defer])<br />Deps: _22, _63<br />~>Query.forums[]"):::bucket
    style Bucket2 stroke:#7f007f
    Bucket1 --> Bucket2
    Bucket3("Bucket 3 (item_41)<br />Deps: _34, _63<br />~>Query.forums[]>Forum.messagesConnection>MessagesConnection.nodes[]<br />~>Query.forums[]>Forum.messagesConnection>MessagesConnection.edges[]"):::bucket
