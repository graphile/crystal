...
graph TD
    ...
    PgClassExpression_44["PgClassExpression[_44∈3@1] {2,3}<br /><__messages...author_id#quot;>"]:::plan
    ...
    PgClassExpression_51["PgClassExpression[_51∈3@1] {2,3}<br /><__users__.#quot;username#quot;>"]:::plan
    PgClassExpression_52["PgClassExpression[_52∈3@1] {2,3}<br /><__users__....vatar_url#quot;>"]:::plan
    ...
    class __Value_3,__Value_5,__TrackedObject_6,PgSelect_17,Access_61,Access_62,Object_63 bucket0
    ...
    Bucket0 --> Bucket1
    Bucket2("Bucket 2 (group 1 / defer)<br />>forums[]"):::bucket
    style Bucket2 stroke:#808000
    Bucket1 --> Bucket2
    Bucket3("Bucket 3 (__Item[_41])<br />>forums[]>messa…ction>nodes[]<br />>forums[]>messa…ction>edges[]"):::bucket
