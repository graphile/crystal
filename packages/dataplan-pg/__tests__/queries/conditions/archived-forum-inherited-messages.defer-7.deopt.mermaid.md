...
graph TD
    ...
    PgClassExpression_44["PgClassExpression[_44∈3@1] {2,3}<br />ᐸ__messages...author_id”ᐳ"]:::plan
    PgSelect_45[["PgSelect[_45∈3@1] {2,3}<br />ᐸusersᐳ"]]:::plan
    First_49["First[_49∈3@1] {2,3}"]:::plan
    PgSelectSingle_50["PgSelectSingle[_50∈3@1] {2,3}<br />ᐸusersᐳ"]:::plan
    PgClassExpression_51["PgClassExpression[_51∈3@1] {2,3}<br />ᐸ__users__.”username”ᐳ"]:::plan
    PgClassExpression_52["PgClassExpression[_52∈3@1] {2,3}<br />ᐸ__users__....vatar_url”ᐳ"]:::plan
