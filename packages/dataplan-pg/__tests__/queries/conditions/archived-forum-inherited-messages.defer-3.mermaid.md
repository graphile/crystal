...
graph TD
    ...
    Map_68["Map[_68∈2] {1,2}<br /><_42:{”0”:1,”1”:2}>"]:::plan
    List_69["List[_69∈2] {1,2}<br /><_68>"]:::plan
    ...
    Bucket0 --> Bucket1
    Bucket2("Bucket 2 (item_41)<br />Deps: _34<br />~>Query.forums[]>Forum.messagesConnection>MessagesConnection.nodes[]<br />~>Query.forums[]>Forum.messagesConnection>MessagesConnection.edges[]"):::bucket
    style Bucket2 stroke:#7f007f
    Bucket1 --> Bucket2
    Bucket3("Bucket 3 (group2[defer])<br />Deps: _42<br />~>Query.forums[]>Forum.messagesConnection"):::bucket
