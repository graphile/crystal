...
graph TD
    ...
    PgSelect34[["PgSelect[34∈1] {1,2}<br />ᐸmessagesᐳ"]]:::plan
    Constant70["Constant[70∈0]"]:::plan
    __Item41>"__Item[41∈2] {1,2}<br />ᐸ34ᐳ"]:::itemplan
    ...
    class Bucket1,__Item21,PgSelectSingle22,PgClassExpression23,PgClassExpression33,PgSelect34,PgClassExpression39 bucket1
    Bucket2("Bucket 2 (item41)<br />Deps: 34<br />~ᐳQuery.forums[]ᐳForum.messagesConnectionᐳMessagesConnection.nodes[]<br />~ᐳQuery.forums[]ᐳForum.messagesConnectionᐳMessagesConnection.edges[]"):::bucket
