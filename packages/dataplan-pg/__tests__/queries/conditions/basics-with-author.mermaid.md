...
graph TD
    ...
    Bucket1("Bucket 1 (item_21)<br />Deps: _17<br />~>Query.forums[]<br />⠀ROOT <-O- _22<br />⠀⠀name <-L- _23<br />⠀⠀messagesList <-A- _52"):::bucket
    style Bucket1 stroke:#00bfff
    Bucket0 --> Bucket1
    Bucket2("Bucket 2 (item_38)<br />Deps: _52<br />~>Query.forums[]>Forum.messagesList[]<br />⠀ROOT <-O- _39<br />⠀⠀body <-L- _40<br />⠀⠀author <-O- _47<br />⠀⠀⠀author.username <-L- _48<br />⠀⠀⠀author.gravatarUrl <-L- _49"):::bucket
