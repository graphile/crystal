...
lateral (
  select
    ...
    __relational_posts__."title"::text as "2",
    __relational_posts__."description"::text as "3",
    __relational_posts__."note"::text as "4",
    __relational_posts_title_lower__.__relational_posts_title_lower__::text as "5",
