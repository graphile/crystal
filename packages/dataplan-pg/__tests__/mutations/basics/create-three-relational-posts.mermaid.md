...
graph TD
    ...
    Map_206["Map[_206∈1@1]<br /><_56:{”0”:1,”1”:2,”2”:3,”3”:4}>"]:::plan
    List_207["List[_207∈1@1]<br /><_206>"]:::plan
    Map_208["Map[_208∈1@1]<br /><_108:{”0”:1,”1”:2,”2”:3,”3”:4}>"]:::plan
    List_209["List[_209∈1@1]<br /><_208>"]:::plan
    Map_210["Map[_210∈1@1]<br /><_160:{”0”:1,”1”:2,”2”:3,”3”:4}>"]:::plan
    ...
    class Constant_7,Constant_8,PgInsert_9,PgClassExpression_13,Constant_14,Constant_15,Constant_16,PgInsert_17,Constant_21,Constant_22,PgInsert_23,PgClassExpression_27,Constant_28,Constant_29,Constant_30,PgInsert_31,Constant_35,Constant_36,PgInsert_37,PgClassExpression_41,Constant_42,Constant_43,Constant_44,PgInsert_45,PgClassExpression_49,InputStaticLeaf_50,PgSelect_51,First_55,PgSelectSingle_56,PgClassExpression_57,PgPolymorphic_58,First_72,PgClassExpression_94,InputStaticLeaf_102,PgSelect_103,First_107,PgSelectSingle_108,PgClassExpression_109,PgPolymorphic_110,First_124,PgClassExpression_146,InputStaticLeaf_154,PgSelect_155,First_159,PgSelectSingle_160,PgClassExpression_161,PgPolymorphic_162,First_176,PgClassExpression_198,Access_200,Access_201,Object_202,Map_206,List_207,Map_208,List_209,Map_210,List_211 bucket1
    ...
    Bucket1("Bucket 1 (group1[mutation])<br />Deps: _3, _5<br />~>Mutation.createThreeRelationalPosts<br />⠀ROOT <-O- _49<br />⠀⠀query <-O- _5<br />⠀⠀⠀query.i1 <-O- _58<br />⠀⠀⠀⠀query.i1.id <-L- _94<br />⠀⠀⠀query.i2 <-O- _110<br />⠀⠀⠀⠀query.i2.id <-L- _146<br />⠀⠀⠀query.i3 <-O- _162<br />⠀⠀⠀⠀query.i3.id <-L- _198"):::bucket
    style Bucket1 stroke:#00bfff
    Bucket0 --> Bucket1
    Bucket2("Bucket 2 (polymorphic_58[RelationalPost])<br />Deps: _72<br />~>Mutation.createThreeRelationalPosts>CreateRelationalPostPayload.query>Query.i1<br />⠀⠀title <-L- _75<br />⠀⠀description <-L- _76<br />⠀⠀note <-L- _77"):::bucket
    style Bucket2 stroke:#7f007f
    Bucket1 --> Bucket2
    Bucket3("Bucket 3 (polymorphic_110[RelationalPost])<br />Deps: _124<br />~>Mutation.createThreeRelationalPosts>CreateRelationalPostPayload.query>Query.i2<br />⠀⠀title <-L- _127<br />⠀⠀description <-L- _128<br />⠀⠀note <-L- _129"):::bucket
    style Bucket3 stroke:#ffa500
    Bucket1 --> Bucket3
    Bucket4("Bucket 4 (polymorphic_162[RelationalPost])<br />Deps: _176<br />~>Mutation.createThreeRelationalPosts>CreateRelationalPostPayload.query>Query.i3<br />⠀⠀title <-L- _179<br />⠀⠀description <-L- _180<br />⠀⠀note <-L- _181"):::bucket
