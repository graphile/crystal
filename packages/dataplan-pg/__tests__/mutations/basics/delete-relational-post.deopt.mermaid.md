...
graph TD
    ...
    PgClassExpression_14["PgClassExpression[_14∈0] {1}<br /><__relational_posts__>"]:::plan
    PgSelect_15[["PgSelect[_15∈0] {1}<br /><relational_posts>"]]:::plan
    First_19["First[_19∈0] {1}"]:::plan
    PgSelectSingle_20["PgSelectSingle[_20∈0] {1}<br /><relational_posts>"]:::plan
    PgClassExpression_21["PgClassExpression[_21∈0] {1}<br /><__relation...sts__.#quot;id#quot;>"]:::plan
    PgClassExpression_22["PgClassExpression[_22∈0] {1}<br /><__relation...__.#quot;title#quot;>"]:::plan
    PgClassExpression_23["PgClassExpression[_23∈0] {1}<br /><__relation...scription#quot;>"]:::plan
    PgClassExpression_24["PgClassExpression[_24∈0] {1}<br /><__relation...s__.#quot;note#quot;>"]:::plan
    First_30["First[_30∈0] {1}"]:::plan
    PgSelectSingle_31["PgSelectSingle[_31∈0] {1}<br /><text>"]:::plan
    PgClassExpression_32["PgClassExpression[_32∈0] {1}<br /><__relation...le_lower__>"]:::plan
    First_38["First[_38∈0] {1}"]:::plan
    PgSelectSingle_39["PgSelectSingle[_39∈0] {1}<br /><relational_items>"]:::plan
    PgClassExpression_40["PgClassExpression[_40∈0] {1}<br /><__relation...author_id#quot;>"]:::plan
    PgSelect_41[["PgSelect[_41∈0] {1}<br /><people>"]]:::plan
    First_45["First[_45∈0] {1}"]:::plan
    PgSelectSingle_46["PgSelectSingle[_46∈0] {1}<br /><people>"]:::plan
    PgClassExpression_47["PgClassExpression[_47∈0] {1}<br /><__people__.#quot;person_id#quot;>"]:::plan
    PgClassExpression_48["PgClassExpression[_48∈0] {1}<br /><__people__.#quot;username#quot;>"]:::plan
    InputStaticLeaf_50["InputStaticLeaf[_50∈0] {2}"]:::plan
    PgDelete_51[["PgDelete[_51∈0] {2}"]]:::sideeffectplan
    PgClassExpression_55["PgClassExpression[_55∈0] {2}<br /><__relation...sts__.#quot;id#quot;>"]:::plan
    PgClassExpression_56["PgClassExpression[_56∈0] {2}<br /><__relational_posts__>"]:::plan
    PgSelect_57[["PgSelect[_57∈0] {2}<br /><relational_posts>"]]:::plan
    First_61["First[_61∈0] {2}"]:::plan
    PgSelectSingle_62["PgSelectSingle[_62∈0] {2}<br /><relational_posts>"]:::plan
    PgClassExpression_63["PgClassExpression[_63∈0] {2}<br /><__relation...sts__.#quot;id#quot;>"]:::plan
    ...
    First_72["First[_72∈0] {2}"]:::plan
    PgSelectSingle_73["PgSelectSingle[_73∈0] {2}<br /><text>"]:::plan
    PgClassExpression_74["PgClassExpression[_74∈0] {2}<br /><__relation...le_lower__>"]:::plan
    First_80["First[_80∈0] {2}"]:::plan
    PgSelectSingle_81["PgSelectSingle[_81∈0] {2}<br /><relational_items>"]:::plan
    PgClassExpression_82["PgClassExpression[_82∈0] {2}<br /><__relation...author_id#quot;>"]:::plan
    PgSelect_83[["PgSelect[_83∈0] {2}<br /><people>"]]:::plan
    ...
    First_87["First[_87∈0] {2}"]:::plan
    PgSelectSingle_88["PgSelectSingle[_88∈0] {2}<br /><people>"]:::plan
    PgClassExpression_89["PgClassExpression[_89∈0] {2}<br /><__people__.#quot;person_id#quot;>"]:::plan
    PgClassExpression_90["PgClassExpression[_90∈0] {2}<br /><__people__.#quot;username#quot;>"]:::plan
    Map_91["Map[_91∈0] {1}<br /><_20:{#quot;0#quot;:0}>"]:::plan
    List_92["List[_92∈0] {1}<br /><_91>"]:::plan
    Map_93["Map[_93∈0] {1}<br /><_20:{#quot;0#quot;:5}>"]:::plan
    List_94["List[_94∈0] {1}<br /><_93>"]:::plan
    Map_95["Map[_95∈0] {2}<br /><_62:{#quot;0#quot;:0}>"]:::plan
    List_96["List[_96∈0] {2}<br /><_95>"]:::plan
    Map_97["Map[_97∈0] {2}<br /><_62:{#quot;0#quot;:5}>"]:::plan
    List_98["List[_98∈0] {2}<br /><_97>"]:::plan
