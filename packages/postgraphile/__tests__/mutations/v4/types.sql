...
lateral (
  select
    __type_function_mutation__."bigint"::text as "0",
    __type_function_mutation__."numeric"::text as "1",
    __type_function_mutation__."decimal"::text as "2",
    __type_function_mutation__."boolean"::text as "3",
    __type_function_mutation__."varchar" as "4",
    __type_function_mutation__."enum"::text as "5",
    __type_function_mutation__."enum_array"::text as "6",
    __type_function_mutation__."domain"::text as "7",
    __type_function_mutation__."domain2"::text as "8",
    __type_function_mutation__."text_array"::text as "9",
    __type_function_mutation__."json"::text as "10",
    __type_function_mutation__."jsonb"::text as "11",
    __type_function_mutation__."nullable_range"::text as "12",
    __type_function_mutation__."numrange"::text as "13",
    json_build_array(
    ...
    __type_function_mutation__."an_int_range"::text as "15",
    to_char(__type_function_mutation__."timestamp", 'YYYY-MM-DD"T"HH24:MI:SS.US'::text) as "16",
    to_char(__type_function_mutation__."timestamptz", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM'::text) as "17",
    to_char(__type_function_mutation__."date", 'YYYY-MM-DD'::text) as "18",
    to_char(date '1970-01-01' + __type_function_mutation__."time", 'HH24:MI:SS.US'::text) as "19",
    to_char(date '1970-01-01' + __type_function_mutation__."timetz", 'HH24:MI:SS.USTZHTZM'::text) as "20",
    ...
    __type_function_mutation__."money"::numeric::text as "23",
    __type_function_mutation__."compound_type"::text as "24",
    __type_function_mutation__."nested_compound_type"::text as "25",
    __type_function_mutation__."nullable_compound_type"::text as "26",
    __type_function_mutation__."nullable_nested_compound_type"::text as "27",
    __type_function_mutation__."point"::text as "28",
    __type_function_mutation__."nullablePoint"::text as "29",
    __type_function_mutation__."inet"::text as "30",
    __type_function_mutation__."cidr"::text as "31",
    __type_function_mutation__."macaddr"::text as "32",
    __type_function_mutation__."regproc"::text as "33",
    __type_function_mutation__."regprocedure"::text as "34",
    __type_function_mutation__."regoper"::text as "35",
    __type_function_mutation__."regoperator"::text as "36",
    __type_function_mutation__."regclass"::text as "37",
    __type_function_mutation__."regtype"::text as "38",
    __type_function_mutation__."regconfig"::text as "39",
    __type_function_mutation__."regdictionary"::text as "40",
    __type_function_mutation__."text_array_domain"::text as "41",
    __type_function_mutation__."int8_array_domain"::text as "42",
...
select
  __type_function_list_mutation__."bigint"::text as "0",
  __type_function_list_mutation__."numeric"::text as "1",
  __type_function_list_mutation__."decimal"::text as "2",
  __type_function_list_mutation__."boolean"::text as "3",
  __type_function_list_mutation__."varchar" as "4",
  __type_function_list_mutation__."enum"::text as "5",
  __type_function_list_mutation__."enum_array"::text as "6",
  __type_function_list_mutation__."domain"::text as "7",
  __type_function_list_mutation__."domain2"::text as "8",
  __type_function_list_mutation__."text_array"::text as "9",
  __type_function_list_mutation__."json"::text as "10",
  __type_function_list_mutation__."jsonb"::text as "11",
  __type_function_list_mutation__."nullable_range"::text as "12",
  __type_function_list_mutation__."numrange"::text as "13",
  json_build_array(
  ...
  __type_function_list_mutation__."an_int_range"::text as "15",
  to_char(__type_function_list_mutation__."timestamp", 'YYYY-MM-DD"T"HH24:MI:SS.US'::text) as "16",
  to_char(__type_function_list_mutation__."timestamptz", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM'::text) as "17",
  to_char(__type_function_list_mutation__."date", 'YYYY-MM-DD'::text) as "18",
  to_char(date '1970-01-01' + __type_function_list_mutation__."time", 'HH24:MI:SS.US'::text) as "19",
  to_char(date '1970-01-01' + __type_function_list_mutation__."timetz", 'HH24:MI:SS.USTZHTZM'::text) as "20",
  ...
  __type_function_list_mutation__."money"::numeric::text as "23",
  __type_function_list_mutation__."compound_type"::text as "24",
  __type_function_list_mutation__."nested_compound_type"::text as "25",
  __type_function_list_mutation__."nullable_compound_type"::text as "26",
  __type_function_list_mutation__."nullable_nested_compound_type"::text as "27",
  __type_function_list_mutation__."point"::text as "28",
  __type_function_list_mutation__."nullablePoint"::text as "29",
  __type_function_list_mutation__."inet"::text as "30",
  __type_function_list_mutation__."cidr"::text as "31",
  __type_function_list_mutation__."macaddr"::text as "32",
  __type_function_list_mutation__."regproc"::text as "33",
  __type_function_list_mutation__."regprocedure"::text as "34",
  __type_function_list_mutation__."regoper"::text as "35",
  __type_function_list_mutation__."regoperator"::text as "36",
  __type_function_list_mutation__."regclass"::text as "37",
  __type_function_list_mutation__."regtype"::text as "38",
  __type_function_list_mutation__."regconfig"::text as "39",
  __type_function_list_mutation__."regdictionary"::text as "40",
  __type_function_list_mutation__."text_array_domain"::text as "41",
  __type_function_list_mutation__."int8_array_domain"::text as "42",
...
select
  __type_function_connection_mutation__."bigint"::text as "0",
  __type_function_connection_mutation__."numeric"::text as "1",
  __type_function_connection_mutation__."decimal"::text as "2",
  __type_function_connection_mutation__."boolean"::text as "3",
  __type_function_connection_mutation__."varchar" as "4",
  __type_function_connection_mutation__."enum"::text as "5",
  __type_function_connection_mutation__."enum_array"::text as "6",
  __type_function_connection_mutation__."domain"::text as "7",
  __type_function_connection_mutation__."domain2"::text as "8",
...
update "b"."types" as __types__ set "smallint" = $1::"int2", "bigint" = $2::"int8", "numeric" = $3::"numeric", "decimal" = $4::"numeric", "boolean" = $5::"bool", "varchar" = $6::"varchar", "enum" = $7::"b"."color", "enum_array" = $8::"b"."color"[], "domain" = $9::"a"."an_int", "domain2" = $10::"b"."another_int", "text_array" = $11::"text"[], "json" = $12::"json", "jsonb" = $13::"jsonb", "numrange" = $14::"pg_catalog"."numrange", "daterange" = $15::"pg_catalog"."daterange", "an_int_range" = $16::"a"."an_int_range", "timestamp" = $17::"timestamp", "timestamptz" = $18::"timestamptz", "date" = $19::"date", "time" = $20::"time", "timetz" = $21::"timetz", "interval" = $22::"interval", "interval_array" = $23::"interval"[], "money" = $24::"money", "compound_type" = $25::"c"."compound_type", "nested_compound_type" = $26::"b"."nested_compound_type", "point" = $27::"point", "nullablePoint" = $28::"point", "inet" = $29::"inet", "cidr" = $30::"cidr", "macaddr" = $31::"macaddr", "regproc" = $32::"regproc", "regprocedure" = $33::"regprocedure", "regoper" = $34::"regoper", "regoperator" = $35::"regoperator", "regclass" = $36::"regclass", "regtype" = $37::"regtype", "regconfig" = $38::"regconfig", "regdictionary" = $39::"regdictionary", "text_array_domain" = $40::"c"."text_array_domain", "int8_array_domain" = $41::"c"."int8_array_domain" where (__types__."id" = $42::"int4") returning
  ...
  __types__."int8_array_domain"::text as "2",
  __types__."text_array_domain"::text as "3",
  __types__."regdictionary"::text as "4",
  __types__."regconfig"::text as "5",
  __types__."regtype"::text as "6",
  __types__."regclass"::text as "7",
  __types__."regoperator"::text as "8",
  __types__."regoper"::text as "9",
  __types__."regprocedure"::text as "10",
  __types__."regproc"::text as "11",
  __types__."macaddr"::text as "12",
  __types__."cidr"::text as "13",
  __types__."inet"::text as "14",
  __types__."nullablePoint"::text as "15",
  __types__."point"::text as "16",
  __types__."nullable_nested_compound_type"::text as "17",
  __types__."nullable_compound_type"::text as "18",
  __types__."nested_compound_type"::text as "19",
  __types__."compound_type"::text as "20",
  __types__."money"::numeric::text as "21",
  (
    select array_agg(to_char(t, 'YYYY_MM_DD_HH24_MI_SS.US'::text))
    from unnest(__types__."interval_array") t
  )::text as "22",
  to_char(__types__."interval", 'YYYY_MM_DD_HH24_MI_SS.US'::text) as "23",
  to_char(date '1970-01-01' + __types__."timetz", 'HH24:MI:SS.USTZHTZM'::text) as "24",
  to_char(date '1970-01-01' + __types__."time", 'HH24:MI:SS.US'::text) as "25",
  to_char(__types__."date", 'YYYY-MM-DD'::text) as "26",
  to_char(__types__."timestamptz", 'YYYY-MM-DD"T"HH24:MI:SS.USTZHTZM'::text) as "27",
  to_char(__types__."timestamp", 'YYYY-MM-DD"T"HH24:MI:SS.US'::text) as "28",
  __types__."an_int_range"::text as "29",
  json_build_array(
  ...
  __types__."numrange"::text as "31",
  __types__."nullable_range"::text as "32",
  __types__."jsonb"::text as "33",
  __types__."json"::text as "34",
  __types__."text_array"::text as "35",
  __types__."domain2"::text as "36",
  __types__."domain"::text as "37",
  __types__."enum_array"::text as "38",
  __types__."enum"::text as "39",
  __types__."varchar" as "40",
  __types__."boolean"::text as "41",
  __types__."decimal"::text as "42",
  __types__."numeric"::text as "43",
  __types__."bigint"::text as "44"
