...
lateral (
  select
    __temporary_source1__."foo_bar"::text as "0",
    __temporary_source1__."f"::text as "1",
    __temporary_source1__."e"::text as "2",
    __temporary_source1__."d" as "3",
    __temporary_source1__."c"::text as "4",
    __temporary_source1__."b" as "5",
    __temporary_source1__."a"::text as "6",
