select
  ("c"."compound_type_computed_field"(__compound_type__))::text as "0",
  __compound_type__."foo_bar"::text as "1",
  __compound_type__."a"::text as "2",
  (not (__compound_type__ is null))::text as "3",
  __nested_compound_type__."b"::text as "4",
  ("c"."compound_type_computed_field"(__compound_type_2))::text as "5",
  __compound_type_2."foo_bar"::text as "6",
  __compound_type_2."a"::text as "7",
  (not (__compound_type_2 is null))::text as "8",
  __nested_compound_type__."a"::text as "9",
  (not (__nested_compound_type__ is null))::text as "10",
  __types__."nullable_nested_compound_type"::text as "11",
  ("c"."compound_type_computed_field"(__compound_type_3))::text as "12",
  __compound_type_3."foo_bar"::text as "13",
  __compound_type_3."a"::text as "14",
  (not (__compound_type_3 is null))::text as "15",
  __types__."nullable_compound_type"::text as "16",
  ("c"."compound_type_computed_field"(__compound_type_4))::text as "17",
  __compound_type_4."foo_bar"::text as "18",
  __compound_type_4."a"::text as "19",
  (not (__compound_type_4 is null))::text as "20",
  __nested_compound_type_2."b"::text as "21",
  ("c"."compound_type_computed_field"(__compound_type_5))::text as "22",
  __compound_type_5."foo_bar"::text as "23",
  __compound_type_5."a"::text as "24",
  (not (__compound_type_5 is null))::text as "25",
  __nested_compound_type_2."a"::text as "26",
  (not (__nested_compound_type_2 is null))::text as "27",
  __types__."nested_compound_type"::text as "28",
  ("c"."compound_type_computed_field"(__compound_type_6))::text as "29",
  __compound_type_6."foo_bar"::text as "30",
  __compound_type_6."a"::text as "31",
  (not (__compound_type_6 is null))::text as "32",
  __types__."compound_type"::text as "33"
