...
select
  __func_out_out__."second_out" as "0",
  __func_out_out__."first_out"::text as "1",
  (not (__func_out_out__ is null))::text as "2"
from "c"."func_out_out"() as __func_out_out__

select
  __func_out_out_unnamed__."column2" as "0",
  __func_out_out_unnamed__."column1"::text as "1",
...
select
  __func_out_unnamed_out_out_unnamed__."o2" as "0",
  __func_out_unnamed_out_out_unnamed__."column3"::text as "1",
  __func_out_unnamed_out_out_unnamed__."column1"::text as "2",
...
lateral (
  select
    ...
    __func_out_complex__."z"::text as "3",
    ...
    __func_out_complex__."y"::text as "8",
    __func_out_complex__."x"::text as "9",
...
lateral (
  select
    ...
    __person__."person_full_name" as "1",
    __person__."id"::text as "2",
    __func_out_complex_setof__."z"::text as "3",
    __compound_type__."c"::text as "4",
    __compound_type__."b" as "5",
    __compound_type__."a"::text as "6",
    (not (__compound_type__ is null))::text as "7",
    __func_out_complex_setof__."y"::text as "8",
    __func_out_complex_setof__."x"::text as "9",
...
lateral (
  select
    ...
    __func_out_out_compound_type__."o2"::text as "4",
    __func_out_out_compound_type__."o1"::text as "5",
...
select
  __func_out_out_setof__."o2" as "0",
...
lateral (
  select
    __func_returns_table_multi_col__."col2" as "0",
...
lateral (
  select
    ...
    __post__."headline" as "6",
    __post__."id"::text as "7",
    __query_output_two_rows__."post"::text as "8",
    __person_secret_2."sekrit" as "9",
    __person_secret_2."person_id"::text as "10",
    __person_2."id"::text as "11",
    __person_2."person_full_name" as "12",
    __left_arm__."person_id"::text as "13",
    __left_arm__."mood" as "14",
    __left_arm__."length_in_metres"::text as "15",
    __left_arm__."id"::text as "16",
    __query_output_two_rows__."left_arm"::text as "17",
...
lateral (
  select
    __person_computed_out_out__."o2" as "0",
    __person_computed_out_out__."o1" as "1",
    (not (__person_computed_out_out__ is null))::text as "2",
    "c"."person_computed_out"(__person__) as "3",
    __person_computed_inout_out__."o" as "4",
    __person_computed_inout_out__."ino" as "5",
    (not (__person_computed_inout_out__ is null))::text as "6",
    "c"."person_computed_inout"(
      __person__,
      __person_identifiers__."id1"
    ) as "7",
    __person_computed_first_arg_inout_out__."o"::text as "8",
    __person_2."person_full_name" as "9",
    __person_2."id"::text as "10",
    __person_computed_first_arg_inout_out__."person"::text as "11",
    (not (__person_computed_first_arg_inout_out__ is null))::text as "12",
    __person_computed_first_arg_inout__."person_full_name" as "13",
    __person_computed_first_arg_inout__."id"::text as "14",
    (select json_agg(_) from (
      select
        __post__."id"::text as "0"
      from "a"."post" as __post__
      where (
        __person_3."id"::"int4" = __post__."author_id"
      )
      order by __post__."id" asc
    ) _) as "15",
    __person_3."person_full_name" as "16",
    __person_3."id"::text as "17",
    __person_computed_complex__."z"::text as "18",
    __compound_type__."c"::text as "19",
    __compound_type__."b" as "20",
    __compound_type__."a"::text as "21",
    (not (__compound_type__ is null))::text as "22",
    __person_computed_complex__."y"::text as "23",
    __person_computed_complex__."x"::text as "24",
    (not (__person_computed_complex__ is null))::text as "25",
    __person__::text as "26",
    __person__."person_full_name" as "27",
    __person__."id"::text as "28",
  ...
  on TRUE
  left outer join lateral (select (__person_computed_first_arg_inout_out__."person").*) as __person_2
  on TRUE
  ...
  on TRUE
  left outer join lateral (select (__person_computed_complex__."z").*) as __person_3
  on TRUE
