...
lateral (
  select
    ...
    __person_computed_out_out__."o2" as "15",
    __person_computed_out_out__."o1" as "16",
    (not (__person_computed_out_out__ is null))::text as "17",
    __person_3."id"::text as "18",
    __person_3."person_full_name" as "19",
    __person_computed_first_arg_inout_out__."person"::text as "20",
    __person_computed_first_arg_inout_out__."o"::text as "21",
    (not (__person_computed_first_arg_inout_out__ is null))::text as "22",
    "c"."person_computed_out"(__person__) as "23",
    __person_computed_inout_out__."o" as "24",
    __person_computed_inout_out__."ino" as "25",
    (not (__person_computed_inout_out__ is null))::text as "26",
    "c"."person_computed_inout"(
      __person__,
      __person_identifiers__."id1"
    ) as "27",
    __person__::text as "28",
