...
lateral (
  select
    ...
    (select json_agg(_) from (
      ...
      where
        (
          __post_3."headline" = __person_identifiers__."id1"
        ) and (
    ...
    "c"."person_first_name"(__person__) as "10",
    __person__::text as "11",
    __person__."person_full_name" as "12",
