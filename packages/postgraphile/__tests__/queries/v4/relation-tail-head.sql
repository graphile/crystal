select
  ...
  __person_2."email" as "2",
  __person_2."person_full_name" as "3",
  __compound_key__."extra"::text as "4",
...
on (__compound_key__."person_id_2"::"int4" = __person__."id")
left outer join "c"."person" as __person_2
on (__compound_key__."person_id_1"::"int4" = __person_2."id")
...
select
  ...
  __person__."email" as "3",
  __person__."person_full_name" as "4",
  __foreign_key__."compound_key_2"::text as "5",
  __foreign_key__."compound_key_1"::text as "6",
  __foreign_key__."person_id"::text as "7",
