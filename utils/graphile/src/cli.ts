...
import * as behaviorCmd from "./commands/behavior/cli.ts";
import * as configCmd from "./commands/config/cli.ts";
import * as inflectionCmd from "./commands/inflection/cli.ts";
