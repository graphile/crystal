...
- **`options`**: An object containing other miscellaneous options. Options could be:
  ...
  - `jwtOptions`: The options for the `jwt.verify(jwtToken, jwtSecret, jwtOptions)` call. See the [jsonwebtoken documentation](https://github.com/auth0/node-jsonwebtoken#jwtverifytoken-secretorpublickey-options-callback) for further details.
