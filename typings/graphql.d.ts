...
export function getNullableType <T>(type: GraphQLType<T>): GraphQLNullableType<T>
...
export function getNamedType <T>(type: GraphQLType<T>): GraphQLNamedType<T>
...
export class GraphQLInputObjectType<TSource> {
  name: string
  description: string | undefined
  constructor (config: GraphQLInputObjectTypeConfig<TSource>)
  getFields (): GraphQLInputObjectFieldMap<TSource>
  toString (): string
}

type GraphQLInputObjectTypeConfig<TSource> = {
  name: string,
  fields: MaybeThunk<GraphQLInputFieldConfigMap<TSource>>,
  description?: string | undefined,
}

type GraphQLInputFieldConfigMap<TSource> = {
  [fieldName: string]: GraphQLInputFieldConfig<any>,
}
...
export class GraphQLList<TSource, TGraphQLType extends GraphQLType<any>> {
  ofType: TGraphQLType
