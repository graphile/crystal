...
interface RegisterObjectType {
     ...
     */
    <TStep extends Step>(typeName: string, scope: GraphileBuild.ScopeObject, specGenerator: () => Omit<GraphileBuild.GrafastObjectTypeConfig<TStep>, "name">, origin: string | null | undefined): void;
    /**
     * @deprecated Please pass 'assertStep' as part of the object spec. This
     * compatibility signature will not be supported for long!
     */
    <TStep extends Step>(typeName: string, scope: GraphileBuild.ScopeObject, assertStep: TStep extends Step ? ((step: Step) => asserts step is TStep) | {
        new (...args: any[]): TStep;
    } : null, specGenerator: () => Omit<GraphileBuild.GrafastObjectTypeConfig<TStep>, "name">, origin: string | null | undefined): void;
}
declare global {
    namespace GraphileBuild {
        type BehaviorString = (string & {
            readonly __incomingBehaviorString: unique symbol;
        ...
        interface GrafastObjectTypeConfig<TParentStep extends Step = Step> extends Omit<GraphQLObjectTypeConfig<unknown, Grafast.Context>, "fields" | "interfaces"> {
            fields?: GrafastFieldConfigMap<TParentStep> | ((context: ContextObjectFields) => GrafastFieldConfigMap<TParentStep>);
        ...
        interface GrafastInputObjectTypeConfig extends Omit<GraphQLInputObjectTypeConfig, "fields"> {
            fields?: GrafastInputFieldConfigMap<any> | ((context: ContextInputObjectFields) => GrafastInputFieldConfigMap<any>);
        }
        /** Our take on GraphQLUnionTypeConfig that allows for plans */
        interface GrafastUnionTypeConfig<TSource> extends Omit<GraphQLUnionTypeConfig<TSource, Grafast.Context>, "types"> {
        ...
        interface GrafastInterfaceTypeConfig<TSource> extends Omit<GraphQLInterfaceTypeConfig<TSource, Grafast.Context>, "fields" | "interfaces"> {
            fields?: GraphQLFieldConfigMap<TSource, Grafast.Context> | ((context: ContextInterfaceFields) => GraphQLFieldConfigMap<TSource, Grafast.Context>);
        ...
        interface BuildBase {
            ...
            registerInterfaceType: (typeName: string, scope: ScopeInterface, specGenerator: () => Omit<GrafastInterfaceTypeConfig<any>, "name">, origin: string | null | undefined) => void;
            /** As registerObjectType, but for unions */
            registerUnionType: (typeName: string, scope: ScopeUnion, specGenerator: () => Omit<GrafastUnionTypeConfig<any>, "name">, origin: string | null | undefined) => void;
            ...
            getTypeMetaByName: (typeName: string) => {
                ...
                specGenerator: (() => Omit<GraphileBuild.GrafastObjectTypeConfig<any>, "name">) | (() => Omit<GrafastInterfaceTypeConfig<any>, "name">) | (() => Omit<GrafastUnionTypeConfig<any>, "name">) | (() => Omit<GraphQLScalarTypeConfig<any, any>, "name">) | (() => Omit<GraphQLEnumTypeConfig, "name">) | (() => Omit<GrafastInputObjectTypeConfig, "name">);
            } | null;
            /**
             ...
             */
            assertValidName(name: string, message: string, args?: string[], allowDoubleUnderscorePrefix?: boolean): string;
            _pluginMeta: {
        ...
        interface ContextObjectFieldsFieldArgs extends Omit<ContextObjectFieldsField, "fieldWitHHooks"> {
         ...
         * non-trivial fields.
         */
        type FieldWithHooksFunction = <TType extends GraphQLOutputType, TParentStep extends Step, TFieldStep extends OutputPlanForType<TType>, TArgs extends BaseGraphQLArguments>(fieldScope: ScopeObjectFieldsField, spec: GrafastFieldConfig<TType, TParentStep, TFieldStep, TArgs> | ((context: ContextObjectFieldsField) => GrafastFieldConfig<TType, TParentStep, TFieldStep, TArgs>)) => GrafastFieldConfig<TType, TParentStep, TFieldStep, TArgs>;
        ...
        type InputFieldWithHooksFunction = (fieldScope: ScopeInputObjectFieldsField, spec: GrafastInputFieldConfig | ((context: ContextInputObjectFieldsField) => GrafastInputFieldConfig)) => GrafastInputFieldConfig;
        /**
        ...
        interface SchemaBuilderHooks<TBuild extends GraphileBuild.Build = GraphileBuild.Build> {
             ...
             */
            GraphQLObjectType: GraphileBuild.Hook<GrafastObjectTypeConfig<any>, GraphileBuild.ContextObject, TBuild>[];
            GraphQLObjectType_interfaces: GraphileBuild.Hook<GraphQLInterfaceType[], GraphileBuild.ContextObjectInterfaces, TBuild>[];
            GraphQLObjectType_fields: GraphileBuild.Hook<GrafastFieldConfigMap<any>, GraphileBuild.ContextObjectFields, TBuild>[];
            GraphQLObjectType_fields_field: GraphileBuild.Hook<GrafastFieldConfig<any, any, any, any>, GraphileBuild.ContextObjectFieldsField, TBuild>[];
            GraphQLObjectType_fields_field_args: GraphileBuild.Hook<GrafastFieldConfigArgumentMap, GraphileBuild.ContextObjectFieldsFieldArgs, TBuild>[];
            GraphQLObjectType_fields_field_args_arg: GraphileBuild.Hook<GrafastArgumentConfig<any, any, any>, GraphileBuild.ContextObjectFieldsFieldArgsArg, TBuild>[];
            /**
            ...
            GraphQLInputObjectType_fields_field: GraphileBuild.Hook<GrafastInputFieldConfig, GraphileBuild.ContextInputObjectFieldsField, TBuild>[];
            /**
             ...
             */
            GraphQLUnionType: GraphileBuild.Hook<GraphileBuild.GrafastUnionTypeConfig<any>, GraphileBuild.ContextUnion, TBuild>[];
             ...
             */
            GraphQLInterfaceType: GraphileBuild.Hook<GraphileBuild.GrafastInterfaceTypeConfig<any>, GraphileBuild.ContextInterface, TBuild>[];
 ...
 */
export type SpecForType<TType extends GraphQLNamedType | GraphQLSchema> = TType extends GraphQLSchema ? Partial<GraphQLSchemaConfig> : TType extends GraphQLObjectType ? Partial<GraphileBuild.GrafastObjectTypeConfig<any>> & {
    name: string;
} : TType extends GraphQLInterfaceType ? Partial<GraphileBuild.GrafastInterfaceTypeConfig<any>> & {
    name: string;
} : TType extends GraphQLUnionType ? Partial<GraphileBuild.GrafastUnionTypeConfig<any>> & {
    name: string;
