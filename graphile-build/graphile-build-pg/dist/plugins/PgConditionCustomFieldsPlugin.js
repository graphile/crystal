...
exports.PgConditionCustomFieldsPlugin = void 0;
...
exports.PgConditionCustomFieldsPlugin = {
    ...
    schema: {
        behaviorRegistry: {
            add: {
                "proc:filterBy": {
                    description: "can we filter by the result of this proc (function resource)",
                    entities: ["pgResource"],
                },
            },
        },
                ...
                return build.extend(fields, functionSources.reduce((memo, rawPgFieldSource) => {
                    ...
                    memo = build.extend(memo, {
                        [fieldName]: fieldWithHooks({
                            ...
                            type,
                            apply: (0, graphile_build_1.EXPORTABLE)((pgFieldSource, sql, sqlValueWithCodec) => function plan($condition, val) {
                                if (val === undefined)
                                    return;
                                ...
                                $condition.where(val === null
                                    ? sql `${expression} is null`
                                    : sql `${expression} = ${sqlValueWithCodec(val, pgFieldSource.codec)}`);
                            }, [pgFieldSource, sql, pg_1.sqlValueWithCodec]),
                        }),
