        ...
        hooks: {
            ...
            init: {
                ...
                callback: (_, build) => {
                    ...
                    build.registerScalarType(inflection.builtin("Base64EncodedBinary"), {}, () => ({
                        description: build.wrapDescription("Binary data encoded using Base64", "type"),
                        serialize: (0, graphile_build_1.EXPORTABLE)(() => function serialize(data) {
                        ...
                        parseValue: (0, graphile_build_1.EXPORTABLE)((GraphQLError) => function parseValue(data) {
                        ...
                        parseLiteral: (0, graphile_build_1.EXPORTABLE)((GraphQLError, Kind) => function parseLiteral(ast) {
                    ...
                    build.registerObjectType(inflection.builtin("Interval"), { isPgIntervalType: true }, () => ({
                    ...
                    function registerGeometry(typeName, description, fieldGen, inputFieldGen) {
                        build.registerObjectType(inflection.builtin(typeName), { [`isPg${typeName}Type`]: true }, () => ({
