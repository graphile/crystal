...
create table person_account (
  person_id        uuid not null primary key references person(id),
...
comment on function post_summary(post, int, text) is 'A truncated version of the body for summaries.';
...
comment on function register_person(text, text, text, text) is 'Register a person in our forum.';
