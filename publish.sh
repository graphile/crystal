...
case $doit in
  y|Y)
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/graphile__lru.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/tamedevil.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/graphile-config.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/ruru-components.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/ruru.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/grafast.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/grafserv.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/dataplan__json.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/eslint-plugin-graphile-export.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/graphile-utils.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/graphile-export.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/jest-serializer-graphql-schema.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/jest-serializer-simple.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/graphile-build.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/pg-introspection.tgz"
    npm publish --access=public --tag="$TAG" "$BUILD_DIR/pg-sql2.tgz"
